# DCGB-OSM-WAY-1481787911

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 38 / 100  |  OSM element `DCGB-OSM-WAY-1481787911`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-1481787911` |
| OSM element | https://www.openstreetmap.org/way/1481787911 |
| coordinates (lat, lon) | 51.5130834, -0.578807 |
...
The nearest named point in the pinned V8 `datacentres` layer is 2.61 km away, recorded as "Kao Data KLON-06".
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 2.13 km |
