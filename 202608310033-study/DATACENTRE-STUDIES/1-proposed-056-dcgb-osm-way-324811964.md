# DCGB-OSM-WAY-324811964

**Verdict: WATCH - PROPOSED**  |  demand score 56 / 100  |  OSM element `DCGB-OSM-WAY-324811964`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-324811964` |
| OSM element | https://www.openstreetmap.org/way/324811964 |
| coordinates (lat, lon) | 51.5049006, -0.3689938 |
...
The nearest named point in the pinned V8 `datacentres` layer is 2.63 km away, recorded as "VIRTUS LONDON2".
...
| measure | value |
|---|---|
| nearest transmission circuit | 2.97 km at 275 kV |
| nearest substation | 0.89 km |
| that substation, voltage | 33000 |
| that substation, name | _unnamed in source_ |

Within 2.97 km of a 275 kV circuit - a workable connection distance for a load of this kind.

## 4. Generation adjacency - the pairing that matters

| measure | value |
|---|---|
| nearest live solar or BESS project | 7.60 km |
