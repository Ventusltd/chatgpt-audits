# The Bunker - South East Data Centre

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 48 / 100  |  OSM element `DCGB-OSM-WAY-460210729`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-460210729` |
| OSM element | https://www.openstreetmap.org/way/460210729 |
| coordinates (lat, lon) | 51.271195, 1.2963278 |
...
element: **The Bunker - South East Data Centre**.
...
| measure | value |
|---|---|
| nearest transmission circuit | 1.48 km at 132 kV |
| nearest substation | 4.17 km |
| that substation, voltage | 33000 / 11000 |
| that substation, name | Pfizers |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 4.29 km |
| that project | Wharf Road, Discovery Park - Battery Energy Storage |
| its capacity | 10 MW |
| its inferred window state | **PAST_EXPECTED_START** |
| its REPD reference | `15093` |
