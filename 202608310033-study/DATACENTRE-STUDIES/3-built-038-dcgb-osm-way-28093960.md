# DCGB-OSM-WAY-28093960

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 38 / 100  |  OSM element `DCGB-OSM-WAY-28093960`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-28093960` |
| OSM element | https://www.openstreetmap.org/way/28093960 |
| coordinates (lat, lon) | 51.4533805, 0.2580033 |
...
The nearest named point in the pinned V8 `datacentres` layer is 3.20 km away, recorded as "Fujitsu Data Centre".
...
| measure | value |
|---|---|
| nearest transmission circuit | 0.72 km at 400 kV |
| nearest substation | 0.54 km |
| that substation, voltage | 33000 / 750 |
| that substation, name | Stone Crossing DC Traction Substation |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 1.86 km |
| that project | Bluewater Shopping Centre, Upper Thames Walk - Solar Photovoltaic Panel |
| its capacity | 1.28 MW |
| its inferred window state | **PAST_EXPECTED_START** |
| its REPD reference | `13138` |
