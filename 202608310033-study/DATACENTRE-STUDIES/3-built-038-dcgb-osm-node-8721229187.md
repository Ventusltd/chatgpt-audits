# DCGB-OSM-NODE-8721229187

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 38 / 100  |  OSM element `DCGB-OSM-NODE-8721229187`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-NODE-8721229187` |
| OSM element | https://www.openstreetmap.org/node/8721229187 |
| coordinates (lat, lon) | 53.003893, -2.2699405 |
...
| nearest substation | 2.42 km |
| that substation, voltage | 33000 |
| that substation, name | Scot Hay Substation |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 3.57 km |
| that project | Rubber and Allied Products |
| its capacity | 40 MW |
| its inferred window state | **PAST_EXPECTED_START** |
| its REPD reference | `7096` |
