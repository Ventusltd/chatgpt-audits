# DCGB-OSM-NODE-14056398202

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 38 / 100  |  OSM element `DCGB-OSM-NODE-14056398202`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-NODE-14056398202` |
| OSM element | https://www.openstreetmap.org/node/14056398202 |
| coordinates (lat, lon) | 51.2929363, -0.7880689 |
...
The nearest named point in the pinned V8 `datacentres` layer is 1.25 km away, recorded as "Unknown Data Centre".
...
| measure | value |
|---|---|
| nearest transmission circuit | 1.59 km at 132 kV |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 2.63 km |
