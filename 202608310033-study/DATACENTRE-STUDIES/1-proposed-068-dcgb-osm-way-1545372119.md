# DCGB-OSM-WAY-1545372119

**Verdict: WATCH - PROPOSED**  |  demand score 68 / 100  |  OSM element `DCGB-OSM-WAY-1545372119`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-1545372119` |
| OSM element | https://www.openstreetmap.org/way/1545372119 |
| coordinates (lat, lon) | 51.8715672, 0.1038561 |
...
The nearest named point in the pinned V8 `datacentres` layer is 11.42 km away, recorded as "Kao Data KLON-02".
...
| measure | value |
|---|---|
| nearest transmission circuit | 1.24 km at 400 kV |
| nearest substation | 2.71 km |
| that substation, voltage | 132000 / 33000 |
| that substation, name | Bishop's Stortford Substation |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 2.45 km |
| that project | Wickham Hall Estate Solar Photovoltaic Farm |
| its capacity | 35 MW |
| its inferred window state | **PAST_EXPECTED_START** |
| its REPD reference | `10265` |
