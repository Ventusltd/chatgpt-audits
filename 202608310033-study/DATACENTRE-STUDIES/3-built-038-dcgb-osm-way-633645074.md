# DCGB-OSM-WAY-633645074

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 38 / 100  |  OSM element `DCGB-OSM-WAY-633645074`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-633645074` |
| OSM element | https://www.openstreetmap.org/way/633645074 |
| coordinates (lat, lon) | 55.7804481, -4.1004178 |
...
The nearest named point in the pinned V8 `datacentres` layer is 11.02 km away, recorded as "DataVita DV1".
...
| measure | value |
|---|---|
| nearest transmission circuit | 0.77 km at 275 kV |
| nearest substation | 3.22 km |
| that substation, voltage | 275000 / 132000 |
| that substation, name | Strathaven Substation |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 1.60 km |
| that project | Malcolmwood Farm, Loanend Road - Battery Energy Storage System |
| its capacity | 49.5 MW |
| its inferred window state | **PRE_CONSENT** |
| its REPD reference | `18736` |
