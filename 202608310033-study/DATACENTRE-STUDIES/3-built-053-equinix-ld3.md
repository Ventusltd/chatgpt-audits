...
**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 53 / 100  |  OSM element `DCGB-OSM-WAY-27618500`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-27618500` |
| OSM element | https://www.openstreetmap.org/way/27618500 |
| coordinates (lat, lon) | 51.528887, -0.2778211 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 1.52 km at 132 kV |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 0.96 km |
