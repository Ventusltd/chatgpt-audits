# DCGB-OSM-WAY-194508831

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 42 / 100  |  OSM element `DCGB-OSM-WAY-194508831`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-194508831` |
| OSM element | https://www.openstreetmap.org/way/194508831 |
| coordinates (lat, lon) | 51.4713244, -0.4232704 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 3.29 km at 275 kV |
| nearest substation | 1.07 km |
| that substation, voltage | 33000 / 11000 |
| that substation, name | _unnamed in source_ |

Within 3.29 km of a 275 kV circuit - a workable connection distance for a load of this kind.

## 4. Generation adjacency - the pairing that matters

| measure | value |
|---|---|
| nearest live solar or BESS project | 3.76 km |
...
3.76 km of this load. Private-wire, co-location and behind-the-meter conversations are live *now*, and the
