# DCGB-OSM-WAY-838773806

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 47 / 100  |  OSM element `DCGB-OSM-WAY-838773806`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-838773806` |
| OSM element | https://www.openstreetmap.org/way/838773806 |
| coordinates (lat, lon) | 51.5016648, -0.4101919 |
...
The nearest named point in the pinned V8 `datacentres` layer is 0.71 km away, recorded as "VIRTUS LONDON2".
...
| measure | value |
|---|---|
| nearest transmission circuit | 0.21 km at 275 kV |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 6.88 km |
...
A live generation project inside the inferred commercial window sits 6.88 km away. Too far for a private wire
