...
**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 40 / 100  |  OSM element `DCGB-OSM-WAY-1305758728`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-1305758728` |
| OSM element | https://www.openstreetmap.org/way/1305758728 |
| coordinates (lat, lon) | 51.7701046, 0.1293794 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 4.38 km at 132 kV |
| nearest substation | 0.15 km |
| that substation, voltage | 33000 |
| that substation, name | _unnamed in source_ |

Within 4.38 km of a 132 kV circuit - a workable connection distance for a load of this kind.

## 4. Generation adjacency - the pairing that matters

| measure | value |
|---|---|
| nearest live solar or BESS project | 4.08 km |
| that project | Poundland Distribution Centre - Solar Photovoltaic System |
| its capacity | 1.5 MW |
| its inferred window state | **PAST_EXPECTED_START** |
| its REPD reference | `11459` |
