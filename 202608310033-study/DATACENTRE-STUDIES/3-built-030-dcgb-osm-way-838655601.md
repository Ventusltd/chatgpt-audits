# DCGB-OSM-WAY-838655601

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 30 / 100  |  OSM element `DCGB-OSM-WAY-838655601`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-838655601` |
| OSM element | https://www.openstreetmap.org/way/838655601 |
| coordinates (lat, lon) | 51.2824377, -0.7945139 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 2.51 km at 132 kV |
| nearest substation | 0.26 km |
| that substation, voltage | 33000 |
| that substation, name | _unnamed in source_ |

Within 2.51 km of a 132 kV circuit - a workable connection distance for a load of this kind.

## 4. Generation adjacency - the pairing that matters

| measure | value |
|---|---|
| nearest live solar or BESS project | 2.53 km |
