# DCGB-OSM-WAY-1046859137

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 38 / 100  |  OSM element `DCGB-OSM-WAY-1046859137`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-1046859137` |
| OSM element | https://www.openstreetmap.org/way/1046859137 |
| coordinates (lat, lon) | 52.2058954, -2.1566924 |
...
| nearest substation | 2.84 km |
| that substation, voltage | 132000 / 11000 |
| that substation, name | Warndon Substation |
...
| that project | Droitwich Road, Martin Hussingtree - Solar Park |
| its capacity | 4 MW |
| its inferred window state | **PRE_CONSENT** |
| its REPD reference | `13979` |
