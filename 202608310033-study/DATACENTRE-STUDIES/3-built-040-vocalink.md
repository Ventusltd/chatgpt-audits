...
**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 40 / 100  |  OSM element `DCGB-OSM-WAY-129823651`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-129823651` |
| OSM element | https://www.openstreetmap.org/way/129823651 |
| coordinates (lat, lon) | 53.9758144, -1.569003 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 3.09 km at 132 kV |
| nearest substation | 1.42 km |
| that substation, voltage | 33000 / 11000 |
| that substation, name | Harrogate West |

Within 3.09 km of a 132 kV circuit - a workable connection distance for a load of this kind.
...
| that project | Jenny Field Drive |
| its capacity | 5 MW |
| its inferred window state | **PAST_EXPECTED_START** |
| its REPD reference | `7075` |
