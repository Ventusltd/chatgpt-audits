# DCGB-OSM-WAY-706624099

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 43 / 100  |  OSM element `DCGB-OSM-WAY-706624099`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-706624099` |
| OSM element | https://www.openstreetmap.org/way/706624099 |
| coordinates (lat, lon) | 51.5347469, -0.2608292 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 0.20 km at 132 kV |
