...
**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 48 / 100  |  OSM element `DCGB-OSM-NODE-8325036723`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-NODE-8325036723` |
| OSM element | https://www.openstreetmap.org/node/8325036723 |
| coordinates (lat, lon) | 50.8678009, -1.2456113 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 0.66 km at 400 kV |
| nearest substation | 0.98 km |
| that substation, voltage | 33000 / 11000 |
| that substation, name | Plessey Titchfield Substation |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 0.43 km |
| that project | Concorde Way, Segensworth - Solar Panels |
| its capacity | 1.04 MW |
| its inferred window state | **DESIGN_FROZEN_OR_LATER** |
| its REPD reference | `11755` |
