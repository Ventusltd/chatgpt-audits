# DCGB-OSM-WAY-326884636

**Verdict: WATCH - PROPOSED**  |  demand score 77 / 100  |  OSM element `DCGB-OSM-WAY-326884636`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-326884636` |
| OSM element | https://www.openstreetmap.org/way/326884636 |
| coordinates (lat, lon) | 51.5003976, -0.402857 |
...
The nearest named point in the pinned V8 `datacentres` layer is 0.46 km away, recorded as "VIRTUS LONDON2".
...
| measure | value |
|---|---|
| nearest transmission circuit | 0.57 km at 275 kV |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 7.07 km |
...
A live generation project inside the inferred commercial window sits 7.07 km away. Too far for a private wire
