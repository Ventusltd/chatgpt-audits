...
**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 40 / 100  |  OSM element `DCGB-OSM-WAY-1122158384`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-1122158384` |
| OSM element | https://www.openstreetmap.org/way/1122158384 |
| coordinates (lat, lon) | 51.5240125, -1.7643629 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 4.73 km at 132 kV |
| nearest substation | 2.19 km |
| that substation, voltage | 33000 |
| that substation, name | _unnamed in source_ |

Within 4.73 km of a 132 kV circuit - a workable connection distance for a load of this kind.
