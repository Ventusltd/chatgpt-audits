# DCGB-OSM-WAY-194258560

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 38 / 100  |  OSM element `DCGB-OSM-WAY-194258560`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-194258560` |
| OSM element | https://www.openstreetmap.org/way/194258560 |
| coordinates (lat, lon) | 51.4947787, -0.0191726 |
...
The nearest named point in the pinned V8 `datacentres` layer is 0.23 km away, recorded as "Digital Realty LHR19".
...
| measure | value |
|---|---|
| nearest transmission circuit | 1.26 km at 132 kV |
| nearest substation | 0.63 km |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 0.85 km |
