# DCGB-OSM-WAY-1460602301

**Verdict: WATCH - BUILDING**  |  demand score 58 / 100  |  OSM element `DCGB-OSM-WAY-1460602301`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-1460602301` |
| OSM element | https://www.openstreetmap.org/way/1460602301 |
| coordinates (lat, lon) | 51.6798089, -0.8333701 |
...
The nearest named point in the pinned V8 `datacentres` layer is 7.64 km away, recorded as "Unknown Data Centre".
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 8.77 km |
