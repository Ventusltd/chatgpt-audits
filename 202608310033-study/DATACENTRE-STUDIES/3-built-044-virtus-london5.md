...
**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 44 / 100  |  OSM element `DCGB-OSM-WAY-705085806`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-705085806` |
| OSM element | https://www.openstreetmap.org/way/705085806 |
| coordinates (lat, lon) | 51.5095441, -0.4542871 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 2.71 km at 132 kV |
| nearest substation | 0.09 km |
| that substation, voltage | 66000 |
| that substation, name | _unnamed in source_ |

Within 2.71 km of a 132 kV circuit - a workable connection distance for a load of this kind.
