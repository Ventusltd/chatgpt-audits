# Global Technical Realty London GB One

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 48 / 100  |  OSM element `DCGB-OSM-WAY-1482210622`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-1482210622` |
| OSM element | https://www.openstreetmap.org/way/1482210622 |
| coordinates (lat, lon) | 51.5176697, -0.6183615 |
...
element: **Global Technical Realty London GB One**.
