# DCGB-OSM-WAY-93984382

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 38 / 100  |  OSM element `DCGB-OSM-WAY-93984382`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-93984382` |
| OSM element | https://www.openstreetmap.org/way/93984382 |
| coordinates (lat, lon) | 51.4274231, -0.9787351 |
...
The nearest named point in the pinned V8 `datacentres` layer is 0.79 km away, recorded as "Redcentric Reading".
...
| measure | value |
|---|---|
| nearest transmission circuit | 1.35 km at 132 kV |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 4.18 km |
