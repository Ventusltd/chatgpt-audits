...
**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 48 / 100  |  OSM element `DCGB-OSM-WAY-200338749`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-200338749` |
| OSM element | https://www.openstreetmap.org/way/200338749 |
| coordinates (lat, lon) | 51.5740371, -1.3153016 |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 0.17 km |
| that project | Rutherford Appleton Laboratory |
| its capacity | 1.6 MW |
| its inferred window state | **PAST_EXPECTED_START** |
| its REPD reference | `9016` |
