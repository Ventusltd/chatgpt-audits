...
**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 40 / 100  |  OSM element `DCGB-OSM-WAY-286648420`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-286648420` |
| OSM element | https://www.openstreetmap.org/way/286648420 |
| coordinates (lat, lon) | 52.3121903, -1.8833659 |
...
element: **Evoque Data Center Solutions**.
...
| measure | value |
|---|---|
| nearest transmission circuit | 4.93 km at 400 kV |
| nearest substation | 2.79 km |
| that substation, voltage | 66000 / 11000 |
| that substation, name | Ipsley Substation |

Within 4.93 km of a 400 kV circuit - a workable connection distance for a load of this kind.

## 4. Generation adjacency - the pairing that matters

| measure | value |
|---|---|
| nearest live solar or BESS project | 0.65 km |
| that project | Thorlux Lighting Moons, Merse Road - Solar PV system |
| its capacity | 1.43 MW |
| its inferred window state | **PAST_EXPECTED_START** |
| its REPD reference | `10528` |
