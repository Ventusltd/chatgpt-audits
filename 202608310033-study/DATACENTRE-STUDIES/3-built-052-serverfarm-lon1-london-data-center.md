# Serverfarm LON1 – London Data Center

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 52 / 100  |  OSM element `DCGB-OSM-WAY-154430569`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-154430569` |
| OSM element | https://www.openstreetmap.org/way/154430569 |
| coordinates (lat, lon) | 51.4466633, -0.4542685 |
...
element: **Serverfarm LON1 – London Data Center**.
...
| measure | value |
|---|---|
| nearest transmission circuit | 2.54 km at 275 kV |
| nearest substation | 1.14 km |
| that substation, voltage | 132000 / 33000 / 11000 |
| that substation, name | East Bedfont Substation |

Within 2.54 km of a 275 kV circuit - a workable connection distance for a load of this kind.

## 4. Generation adjacency - the pairing that matters

| measure | value |
|---|---|
| nearest live solar or BESS project | 0.93 km |
...
0.93 km of this load. Private-wire, co-location and behind-the-meter conversations are live *now*, and the
