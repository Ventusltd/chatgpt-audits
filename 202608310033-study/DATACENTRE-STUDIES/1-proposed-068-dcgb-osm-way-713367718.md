# DCGB-OSM-WAY-713367718

**Verdict: WATCH - PROPOSED**  |  demand score 68 / 100  |  OSM element `DCGB-OSM-WAY-713367718`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-713367718` |
| OSM element | https://www.openstreetmap.org/way/713367718 |
| coordinates (lat, lon) | 51.5273111, -0.2552866 |
...
The nearest named point in the pinned V8 `datacentres` layer is 0.30 km away, recorded as "Unknown Data Centre".
...
| measure | value |
|---|---|
| nearest transmission circuit | 0.41 km at 132 kV |
| nearest substation | 0.71 km |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 1.54 km |
