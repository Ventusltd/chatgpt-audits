# DCGB-OSM-WAY-1303852315

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 16 / 100  |  OSM element `DCGB-OSM-WAY-1303852315`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-1303852315` |
| OSM element | https://www.openstreetmap.org/way/1303852315 |
| coordinates (lat, lon) | 52.3988688, 0.5502103 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 12.84 km at 132 kV |
| nearest substation | 0.71 km |
| that substation, voltage | 33000 / 11000 |
| that substation, name | Lakenheath Gatehouse Primary Substation |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 5.29 km |
| that project | Brandon Fields Estate, Brandon Fields - Solar Panels |
| its capacity | 28 MW |
| its inferred window state | **PRE_CONSENT** |
| its REPD reference | `18537` |
