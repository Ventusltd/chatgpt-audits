# Data Vault - Bournemouth BCP01

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 36 / 100  |  OSM element `DCGB-OSM-NODE-13596137356`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-NODE-13596137356` |
| OSM element | https://www.openstreetmap.org/node/13596137356 |
| coordinates (lat, lon) | 50.7219006, -1.8749448 |
...
element: **Data Vault - Bournemouth BCP01**.
...
| nearest substation | 2.50 km |
| that substation, voltage | 33000 / 11000 |
| that substation, name | Winton 33/11KV |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 5.35 km |
| that project | Parley Court - Solar Farm |
| its capacity | 35 MW |
| its inferred window state | **PAST_EXPECTED_START** |
| its REPD reference | `10041` |
