# DCGB-OSM-WAY-57977045

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 50 / 100  |  OSM element `DCGB-OSM-WAY-57977045`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-57977045` |
| OSM element | https://www.openstreetmap.org/way/57977045 |
| coordinates (lat, lon) | 53.6993157, -1.3976736 |
...
The nearest named point in the pinned V8 `datacentres` layer is 1.41 km away, recorded as "Unknown Data Centre".
...
| measure | value |
|---|---|
| nearest transmission circuit | 0.78 km at 400 kV |
| nearest substation | 1.36 km |
| that substation, voltage | 33000 |
| that substation, name | Premier Way North 1 |

Sitting within 2 km of a 400 kV circuit. For a data centre that is the difference between a
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 0.87 km |
| that project | Cooksland Farm, Old Snydale -Battery Energy Storage |
| its capacity | 50 MW |
| its inferred window state | **FUNDING_WINDOW_INFERRED** |
| its REPD reference | `16557` |

**This is the high-value case.** A live generation project inside the inferred commercial window sits within
0.87 km of this load. Private-wire, co-location and behind-the-meter conversations are live *now*, and the
