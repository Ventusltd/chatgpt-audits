...
**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 52 / 100  |  OSM element `DCGB-OSM-WAY-981640451`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-981640451` |
| OSM element | https://www.openstreetmap.org/way/981640451 |
| coordinates (lat, lon) | 53.5077832, -2.3049271 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 0.48 km at 132 kV |
| nearest substation | 0.64 km |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 5.53 km |
...
A live generation project inside the inferred commercial window sits 5.53 km away. Too far for a private wire
