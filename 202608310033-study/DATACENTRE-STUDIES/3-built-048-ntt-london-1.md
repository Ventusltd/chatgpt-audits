...
**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 48 / 100  |  OSM element `DCGB-OSM-WAY-825504801`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-825504801` |
| OSM element | https://www.openstreetmap.org/way/825504801 |
| coordinates (lat, lon) | 51.547372, 0.1758028 |
...
The pinned V8 `datacentres` layer in `data-gridatlas` carries a named point **10 m** from this
element: **NTT London 1**.
...
| measure | value |
|---|---|
| nearest transmission circuit | 1.93 km at 132 kV |
| nearest substation | 0.18 km |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 4.93 km |
