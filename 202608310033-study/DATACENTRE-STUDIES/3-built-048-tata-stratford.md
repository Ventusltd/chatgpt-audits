...
**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 48 / 100  |  OSM element `DCGB-OSM-WAY-1322919061`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-1322919061` |
| OSM element | https://www.openstreetmap.org/way/1322919061 |
| coordinates (lat, lon) | 51.5424593, 0.0025166 |
...
| that substation, voltage | 132000 / 25000 |
| that substation, name | Bow Network Rail |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 4.68 km |
