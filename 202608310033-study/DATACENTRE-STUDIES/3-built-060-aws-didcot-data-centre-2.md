# AWS Didcot Data Centre

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 60 / 100  |  OSM element `DCGB-OSM-WAY-1270223656`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-1270223656` |
| OSM element | https://www.openstreetmap.org/way/1270223656 |
| coordinates (lat, lon) | 51.6175657, -1.2618997 |
...
The pinned V8 `datacentres` layer in `data-gridatlas` carries a named point **30 m** from this
element: **AWS Didcot Data Centre**.
...
| measure | value |
|---|---|
| nearest transmission circuit | 0.81 km at 400 kV |
...
| that project | Appleford - Battery Energy Storage |
| its capacity | 300 MW |
| its inferred window state | **PROCURING_INFERRED** |
| its REPD reference | `17837` |

**This is the high-value case.** A live generation project inside the inferred commercial window sits within
2.09 km of this load. Private-wire, co-location and behind-the-meter conversations are live *now*, and the
