...
**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 36 / 100  |  OSM element `DCGB-OSM-WAY-203500066`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-203500066` |
| OSM element | https://www.openstreetmap.org/way/203500066 |
| coordinates (lat, lon) | 51.770102, -0.3206157 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 2.84 km at 132 kV |
| nearest substation | 2.08 km |
| that substation, voltage | 33000 / 11000 |
| that substation, name | _unnamed in source_ |

Within 2.84 km of a 132 kV circuit - a workable connection distance for a load of this kind.

## 4. Generation adjacency - the pairing that matters

| measure | value |
|---|---|
| nearest live solar or BESS project | 5.17 km |
| that project | Computacenter Warehouse |
| its capacity | 2 MW |
| its inferred window state | **DESIGN_FROZEN_OR_LATER** |
| its REPD reference | `7290` |
