# Datum Datacentres (MCR2)

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 40 / 100  |  OSM element `DCGB-OSM-WAY-103482135`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-103482135` |
| OSM element | https://www.openstreetmap.org/way/103482135 |
| coordinates (lat, lon) | 53.3786359, -2.2585178 |
...
element: **Datum Datacentres (MCR2)**.
...
| measure | value |
|---|---|
| nearest transmission circuit | 2.92 km at 275 kV |
| nearest substation | 2.20 km |
| that substation, voltage | 132000 |
| that substation, name | Moss Nook |

Within 2.92 km of a 275 kV circuit - a workable connection distance for a load of this kind.

## 4. Generation adjacency - the pairing that matters

| measure | value |
|---|---|
| nearest live solar or BESS project | 3.26 km |
| that project | Sunbank Lane Solar Panels |
| its capacity | 1.51 MW |
| its inferred window state | **PAST_EXPECTED_START** |
| its REPD reference | `9149` |
