...
**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 36 / 100  |  OSM element `DCGB-OSM-WAY-460244928`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-460244928` |
| OSM element | https://www.openstreetmap.org/way/460244928 |
| coordinates (lat, lon) | 51.2476379, -0.1586246 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 6.47 km at 132 kV |
| nearest substation | 0.12 km |
| that substation, voltage | 33000 |
| that substation, name | Redhill Primary |

Within 6.47 km of a 132 kV circuit - a workable connection distance for a load of this kind.
