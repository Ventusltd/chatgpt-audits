# DCGB-OSM-WAY-447240912

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 38 / 100  |  OSM element `DCGB-OSM-WAY-447240912`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-447240912` |
| OSM element | https://www.openstreetmap.org/way/447240912 |
| coordinates (lat, lon) | 52.5833804, -1.2089785 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 0.11 km at 132 kV |
| nearest substation | 0.08 km |
| that substation, voltage | 132000 / 33000 |
| that substation, name | Carlton Park Substation |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 1.61 km |
| that project | Dorsey Way, Enderby - Solar Panels |
| its capacity | 1.797 MW |
| its inferred window state | **PAST_EXPECTED_START** |
| its REPD reference | `15988` |
