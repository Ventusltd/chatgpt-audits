...
**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 26 / 100  |  OSM element `DCGB-OSM-WAY-813089664`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-813089664` |
| OSM element | https://www.openstreetmap.org/way/813089664 |
| coordinates (lat, lon) | 55.1534408, -6.6854646 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 36.28 km at 275 kV |
| nearest substation | 2.23 km |
| that substation, voltage | 33000 |
| that substation, name | ______ 33 kV Substation |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 8.27 km |
| that project | Kells Solar Farm |
| its capacity | 25 MW |
| its inferred window state | **PRE_CONSENT** |
| its REPD reference | `6012` |
