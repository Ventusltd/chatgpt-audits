# DCGB-OSM-WAY-17663535

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 38 / 100  |  OSM element `DCGB-OSM-WAY-17663535`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-17663535` |
| OSM element | https://www.openstreetmap.org/way/17663535 |
| coordinates (lat, lon) | 51.5406763, -2.5817485 |
...
The nearest named point in the pinned V8 `datacentres` layer is 28.31 km away, recorded as "Ark Data Centres".
...
| that substation, name | Oakham Farm Solar Park Substation |
