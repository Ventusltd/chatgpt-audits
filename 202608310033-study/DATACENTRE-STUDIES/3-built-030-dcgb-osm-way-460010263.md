# DCGB-OSM-WAY-460010263

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 30 / 100  |  OSM element `DCGB-OSM-WAY-460010263`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-460010263` |
| OSM element | https://www.openstreetmap.org/way/460010263 |
| coordinates (lat, lon) | 52.0546866, -0.7572426 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 2.73 km at 132 kV |
| nearest substation | 0.82 km |
| that substation, voltage | 33000 |
| that substation, name | Marlborough Street |

Within 2.73 km of a 132 kV circuit - a workable connection distance for a load of this kind.

## 4. Generation adjacency - the pairing that matters

| measure | value |
|---|---|
| nearest live solar or BESS project | 1.99 km |
| that project | Mercedes Benz UK - Solar array car port |
| its capacity | 2 MW |
| its inferred window state | **PAST_EXPECTED_START** |
| its REPD reference | `9277` |
