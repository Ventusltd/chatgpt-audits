# RBS Melville Gate Data Centre

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 60 / 100  |  OSM element `DCGB-OSM-WAY-103765318`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-103765318` |
| OSM element | https://www.openstreetmap.org/way/103765318 |
| coordinates (lat, lon) | 55.8942976, -3.0866159 |
...
element: **RBS Melville Gate Data Centre**.
...
| measure | value |
|---|---|
| nearest transmission circuit | 1.22 km at 400 kV |
| nearest substation | 3.52 km |
| that substation, voltage | 400000 / 275000 |
| that substation, name | Smeaton Substation |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 2.11 km |
| that project | Salters Battery Energy Storage System |
| its capacity | 200 MW |
| its inferred window state | **PROCURING_INFERRED** |
| its REPD reference | `15173` |

**This is the high-value case.** A live generation project inside the inferred commercial window sits within
2.11 km of this load. Private-wire, co-location and behind-the-meter conversations are live *now*, and the
