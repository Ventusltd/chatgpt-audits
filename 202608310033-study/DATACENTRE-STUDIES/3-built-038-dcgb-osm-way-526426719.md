# DCGB-OSM-WAY-526426719

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 38 / 100  |  OSM element `DCGB-OSM-WAY-526426719`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-526426719` |
| OSM element | https://www.openstreetmap.org/way/526426719 |
| coordinates (lat, lon) | 51.8977355, -0.5013188 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 0.50 km at 400 kV |
| nearest substation | 0.85 km |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 0.82 km |
| that project | Dc1 Boscombe Road |
| its capacity | 1.7 MW |
| its inferred window state | **DISTRESSED** |
| its REPD reference | `6711` |
