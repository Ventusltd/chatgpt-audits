# CXD Infrastructure Solutions

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 44 / 100  |  OSM element `DCGB-OSM-WAY-729539167`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-729539167` |
| OSM element | https://www.openstreetmap.org/way/729539167 |
| coordinates (lat, lon) | 51.2788289, 0.5472057 |
...
element: **CXD Infrastructure Solutions**.
...
| measure | value |
|---|---|
| nearest transmission circuit | 0.64 km at 132 kV |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 9.31 km |
