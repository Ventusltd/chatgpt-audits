# Nationwide Swindon Technology Centre

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 48 / 100  |  OSM element `DCGB-OSM-WAY-143146089`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-143146089` |
| OSM element | https://www.openstreetmap.org/way/143146089 |
| coordinates (lat, lon) | 51.5722528, -1.8362321 |
...
The pinned V8 `datacentres` layer in `data-gridatlas` carries a named point **40 m** from this
element: **Nationwide Swindon Technology Centre**.
...
| measure | value |
|---|---|
| nearest transmission circuit | 1.06 km at 132 kV |
| nearest substation | 1.50 km |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 1.47 km |
| that project | Brindley Close (Extension) |
| its capacity | 6 MW |
| its inferred window state | **DESIGN_FROZEN_OR_LATER** |
| its REPD reference | `8045` |
