...
**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 44 / 100  |  OSM element `DCGB-OSM-WAY-838801558`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-838801558` |
| OSM element | https://www.openstreetmap.org/way/838801558 |
| coordinates (lat, lon) | 51.5097605, -0.4571888 |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 6.61 km |
...
A live generation project inside the inferred commercial window sits 6.61 km away. Too far for a private wire
