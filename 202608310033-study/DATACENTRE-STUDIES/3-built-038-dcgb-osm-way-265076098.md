# DCGB-OSM-WAY-265076098

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 38 / 100  |  OSM element `DCGB-OSM-WAY-265076098`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-265076098` |
| OSM element | https://www.openstreetmap.org/way/265076098 |
| coordinates (lat, lon) | 53.5042725, -1.1120203 |
...
The nearest named point in the pinned V8 `datacentres` layer is 28.21 km away, recorded as "Unknown Data Centre".
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 0.70 km |
| that project | J3 Business Park |
| its capacity | 1 MW |
| its inferred window state | **PRE_CONSENT** |
| its REPD reference | `12920` |
