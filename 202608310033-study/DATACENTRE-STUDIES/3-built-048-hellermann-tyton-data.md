# Hellermann Tyton Data

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 48 / 100  |  OSM element `DCGB-OSM-WAY-613855632`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-613855632` |
| OSM element | https://www.openstreetmap.org/way/613855632 |
| coordinates (lat, lon) | 52.234194, -0.919028 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 1.17 km at 132 kV |
| nearest substation | 1.19 km |
| that substation, voltage | 33000 |
| that substation, name | Ellesmere Avenue Substation |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 3.60 km |
| that project | Sainsburys, Style Way - Solar Panels |
| its capacity | 4.5 MW |
| its inferred window state | **PRE_CONSENT** |
| its REPD reference | `21019` |
