...
**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 48 / 100  |  OSM element `DCGB-OSM-WAY-206625800`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-206625800` |
| OSM element | https://www.openstreetmap.org/way/206625800 |
| coordinates (lat, lon) | 51.512052, -0.0019544 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 0.65 km at 132 kV |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 1.55 km |
