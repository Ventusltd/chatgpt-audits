...
**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 48 / 100  |  OSM element `DCGB-OSM-WAY-1349649740`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-1349649740` |
| OSM element | https://www.openstreetmap.org/way/1349649740 |
| coordinates (lat, lon) | 52.5297368, -2.0210407 |
...
| that substation, name | Barton Abrasives Substation |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 1.82 km |
| that project | Midland Quarry Products, Smith Road - Battery Storage |
| its capacity | 10 MW |
| its inferred window state | **PAST_EXPECTED_START** |
| its REPD reference | `14747` |
