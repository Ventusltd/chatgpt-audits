# DCGB-OSM-WAY-1481787912

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 38 / 100  |  OSM element `DCGB-OSM-WAY-1481787912`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-1481787912` |
| OSM element | https://www.openstreetmap.org/way/1481787912 |
| coordinates (lat, lon) | 51.5134671, -0.5768553 |
...
The nearest named point in the pinned V8 `datacentres` layer is 2.74 km away, recorded as "Kao Data KLON-06".
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 2.07 km |
