# DCGB-OSM-WAY-830370910

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 38 / 100  |  OSM element `DCGB-OSM-WAY-830370910`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-830370910` |
| OSM element | https://www.openstreetmap.org/way/830370910 |
| coordinates (lat, lon) | 52.5796263, -1.2062397 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 0.54 km at 132 kV |
| nearest substation | 0.39 km |
| that substation, voltage | 33000 / 11000 |
| that substation, name | Alliance and Leicester Substation |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 1.94 km |
