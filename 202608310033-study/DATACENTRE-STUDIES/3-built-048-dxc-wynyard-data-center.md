# DXC Wynyard Data Center

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 48 / 100  |  OSM element `DCGB-OSM-WAY-201843176`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-201843176` |
| OSM element | https://www.openstreetmap.org/way/201843176 |
| coordinates (lat, lon) | 54.633291, -1.3100648 |
...
element: **DXC Wynyard Data Center**.
...
| measure | value |
|---|---|
| nearest transmission circuit | 0.68 km at 275 kV |
...
| that project | Wynyard Business Park, North Chapell Lane - Solar Panels |
| its capacity | 3.96 MW |
| its inferred window state | **PAST_EXPECTED_START** |
| its REPD reference | `11993` |
