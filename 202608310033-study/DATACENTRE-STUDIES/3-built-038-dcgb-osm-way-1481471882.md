# DCGB-OSM-WAY-1481471882

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 38 / 100  |  OSM element `DCGB-OSM-WAY-1481471882`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-1481471882` |
| OSM element | https://www.openstreetmap.org/way/1481471882 |
| coordinates (lat, lon) | 51.5286059, -0.2571097 |
...
The nearest named point in the pinned V8 `datacentres` layer is 0.18 km away, recorded as "Unknown Data Centre".
...
| measure | value |
|---|---|
| nearest transmission circuit | 0.45 km at 132 kV |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 1.35 km |
