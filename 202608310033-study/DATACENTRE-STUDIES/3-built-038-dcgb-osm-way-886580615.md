# DCGB-OSM-WAY-886580615

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 38 / 100  |  OSM element `DCGB-OSM-WAY-886580615`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-886580615` |
| OSM element | https://www.openstreetmap.org/way/886580615 |
| coordinates (lat, lon) | 51.4569728, -0.9424708 |
...
The nearest named point in the pinned V8 `datacentres` layer is 0.07 km away, recorded as "Pulsant Reading East".
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 0.07 km |
