# DCGB-OSM-WAY-1302345665

**Verdict: WATCH - PROPOSED**  |  demand score 73 / 100  |  OSM element `DCGB-OSM-WAY-1302345665`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-1302345665` |
| OSM element | https://www.openstreetmap.org/way/1302345665 |
| coordinates (lat, lon) | 51.5254151, -0.2767751 |
...
The nearest named point in the pinned V8 `datacentres` layer is 0.39 km away, recorded as "Equinix LD3".
...
| measure | value |
|---|---|
| nearest transmission circuit | 1.67 km at 132 kV |
| nearest substation | 1.60 km |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 1.30 km |
