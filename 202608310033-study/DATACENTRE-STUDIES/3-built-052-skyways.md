...
**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 52 / 100  |  OSM element `DCGB-OSM-WAY-187251460`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-187251460` |
| OSM element | https://www.openstreetmap.org/way/187251460 |
| coordinates (lat, lon) | 51.4595405, -0.4099656 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 4.49 km at 275 kV |
| nearest substation | 1.23 km |
| that substation, voltage | 33000 / 750 |
| that substation, name | Feltham DC Traction Substation |

Within 4.49 km of a 275 kV circuit - a workable connection distance for a load of this kind.

## 4. Generation adjacency - the pairing that matters

| measure | value |
|---|---|
| nearest live solar or BESS project | 4.02 km |
...
4.02 km of this load. Private-wire, co-location and behind-the-meter conversations are live *now*, and the
