# DCGB-OSM-WAY-29120456

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 30 / 100  |  OSM element `DCGB-OSM-WAY-29120456`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-29120456` |
| OSM element | https://www.openstreetmap.org/way/29120456 |
| coordinates (lat, lon) | 51.4915116, 0.1667209 |
...
| nearest substation | 1.11 km |
| that substation, voltage | 33000 / 750 |
| that substation, name | Belvedere DC Traction Substation |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 1.70 km |
| that project | Riverside Resource Recovery Facility Battery Storage |
| its capacity | 2.5 MW |
| its inferred window state | **DESIGN_FROZEN_OR_LATER** |
| its REPD reference | `8261` |
