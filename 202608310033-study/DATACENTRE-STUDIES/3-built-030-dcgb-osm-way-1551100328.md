# DCGB-OSM-WAY-1551100328

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 30 / 100  |  OSM element `DCGB-OSM-WAY-1551100328`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-1551100328` |
| OSM element | https://www.openstreetmap.org/way/1551100328 |
| coordinates (lat, lon) | 53.4750243, -2.6392925 |
...
The nearest named point in the pinned V8 `datacentres` layer is 6.72 km away, recorded as "Iron Mountain".
...
| measure | value |
|---|---|
| nearest transmission circuit | 2.93 km at 132 kV |
| nearest substation | 2.93 km |
| that substation, voltage | 132000 / 33000 |
| that substation, name | Golborne Substation |

Within 2.93 km of a 132 kV circuit - a workable connection distance for a load of this kind.
...
| that project | Poundland Distribution Centre,Three Sisters Road - Solar Panel |
| its capacity | 2.2 MW |
| its inferred window state | **PAST_EXPECTED_START** |
| its REPD reference | `11888` |
