# Centerprise International Newport

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 53 / 100  |  OSM element `DCGB-OSM-NODE-11161995738`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-NODE-11161995738` |
| OSM element | https://www.openstreetmap.org/node/11161995738 |
| coordinates (lat, lon) | 51.5556071, -3.0376928 |
...
element: **Centerprise International Newport**.
...
| measure | value |
|---|---|
| nearest transmission circuit | 0.76 km at 400 kV |
| nearest substation | 0.98 km |
| that substation, voltage | 400000 |
| that substation, name | Imperial Park Substation |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 2.52 km |
| that project | Docks Way Solar Farm |
| its capacity | 2.37 MW |
| its inferred window state | **PAST_EXPECTED_START** |
| its REPD reference | `8923` |
