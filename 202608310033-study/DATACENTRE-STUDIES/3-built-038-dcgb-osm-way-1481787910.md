# DCGB-OSM-WAY-1481787910

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 38 / 100  |  OSM element `DCGB-OSM-WAY-1481787910`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-1481787910` |
| OSM element | https://www.openstreetmap.org/way/1481787910 |
| coordinates (lat, lon) | 51.5124753, -0.5792971 |
...
The nearest named point in the pinned V8 `datacentres` layer is 2.58 km away, recorded as "Kao Data KLON-06".
...
| measure | value |
|---|---|
| nearest transmission circuit | 0.33 km at 132 kV |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 2.20 km |
