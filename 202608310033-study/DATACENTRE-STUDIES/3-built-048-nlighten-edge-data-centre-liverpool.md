# nLighten Edge Data Centre Liverpool

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 48 / 100  |  OSM element `DCGB-OSM-WAY-891871959`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-891871959` |
| OSM element | https://www.openstreetmap.org/way/891871959 |
| coordinates (lat, lon) | 53.3433136, -2.9733309 |
...
element: **nLighten Edge Data Centre Liverpool**.
...
| measure | value |
|---|---|
| nearest transmission circuit | 1.44 km at 132 kV |
| nearest substation | 0.86 km |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 4.97 km |
| that project | Jaguar Landrover Phoenix Building, Eric Foundation Road - Solar Array |
| its capacity | 1.3 MW |
| its inferred window state | **PAST_EXPECTED_START** |
| its REPD reference | `18362` |
