...
**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 40 / 100  |  OSM element `DCGB-OSM-WAY-59191365`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-59191365` |
| OSM element | https://www.openstreetmap.org/way/59191365 |
| coordinates (lat, lon) | 53.4644923, -2.2475306 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 4.94 km at 132 kV |
| nearest substation | 1.38 km |
| that substation, voltage | 132000 |
| that substation, name | BLOOM ST GRID |

Within 4.94 km of a 132 kV circuit - a workable connection distance for a load of this kind.

## 4. Generation adjacency - the pairing that matters

| measure | value |
|---|---|
| nearest live solar or BESS project | 4.03 km |
