# DCGB-OSM-WAY-27618478

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 43 / 100  |  OSM element `DCGB-OSM-WAY-27618478`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-27618478` |
| OSM element | https://www.openstreetmap.org/way/27618478 |
| coordinates (lat, lon) | 51.529043, -0.2742813 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 1.30 km at 132 kV |
| nearest substation | 1.25 km |
