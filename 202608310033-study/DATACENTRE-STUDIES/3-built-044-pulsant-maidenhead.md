...
**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 44 / 100  |  OSM element `DCGB-OSM-WAY-49602062`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-49602062` |
| OSM element | https://www.openstreetmap.org/way/49602062 |
| coordinates (lat, lon) | 51.5003153, -0.7082525 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 1.34 km at 132 kV |
| nearest substation | 2.14 km |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 5.26 km |
