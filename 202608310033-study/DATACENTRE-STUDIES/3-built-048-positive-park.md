...
**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 48 / 100  |  OSM element `DCGB-OSM-WAY-888760205`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-888760205` |
| OSM element | https://www.openstreetmap.org/way/888760205 |
| coordinates (lat, lon) | 52.5837453, 0.0565064 |
...
| that project | West Fen Farm, Whitemoor Road - Solar Farm |
| its capacity | 49.8 MW |
| its inferred window state | **PRE_CONSENT** |
| its REPD reference | `15272` |
