...
**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 48 / 100  |  OSM element `DCGB-OSM-WAY-55873731`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-55873731` |
| OSM element | https://www.openstreetmap.org/way/55873731 |
| coordinates (lat, lon) | 51.3475652, -0.4799467 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 0.36 km at 275 kV |
| nearest substation | 0.28 km |
| that substation, voltage | 33000 / 750 |
| that substation, name | New Haw DC Traction Substation |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 4.50 km |
