# Digital Realty London LON3

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 48 / 100  |  OSM element `DCGB-OSM-WAY-270426364`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-270426364` |
| OSM element | https://www.openstreetmap.org/way/270426364 |
| coordinates (lat, lon) | 51.5215881, -0.0731386 |
...
element: **Digital Realty London LON3**.
...
| measure | value |
|---|---|
| nearest transmission circuit | 0.14 km at 132 kV |
| nearest substation | 0.46 km |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 4.36 km |
