# VIRTUS Slough London 3 and 4

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 48 / 100  |  OSM element `DCGB-OSM-WAY-459572486`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-459572486` |
| OSM element | https://www.openstreetmap.org/way/459572486 |
| coordinates (lat, lon) | 51.5228223, -0.6213452 |
...
element: **VIRTUS Slough London 3 and 4**.
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 3.43 km |
