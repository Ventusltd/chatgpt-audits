# DCGB-OSM-WAY-314914896

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 50 / 100  |  OSM element `DCGB-OSM-WAY-314914896`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-314914896` |
| OSM element | https://www.openstreetmap.org/way/314914896 |
| coordinates (lat, lon) | 53.7034936, -1.377013 |
...
The nearest named point in the pinned V8 `datacentres` layer is 0.03 km away, recorded as "Unknown Data Centre".
...
| measure | value |
|---|---|
| nearest transmission circuit | 0.63 km at 275 kV |
| nearest substation | 0.11 km |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 1.84 km |
...
1.84 km of this load. Private-wire, co-location and behind-the-meter conversations are live *now*, and the
