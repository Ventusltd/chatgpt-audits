...
**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 40 / 100  |  OSM element `DCGB-OSM-WAY-251948724`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-251948724` |
| OSM element | https://www.openstreetmap.org/way/251948724 |
| coordinates (lat, lon) | 55.9293897, -3.4096908 |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 0.94 km |
| that project | Chariot Drive, Newbridge Road - Solar Panels |
| its capacity | 1.22 MW |
| its inferred window state | **PAST_EXPECTED_START** |
| its REPD reference | `12254` |
