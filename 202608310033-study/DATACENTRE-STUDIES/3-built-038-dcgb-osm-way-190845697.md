# DCGB-OSM-WAY-190845697

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 38 / 100  |  OSM element `DCGB-OSM-WAY-190845697`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-190845697` |
| OSM element | https://www.openstreetmap.org/way/190845697 |
| coordinates (lat, lon) | 51.4817516, -0.1261156 |
...
The nearest named point in the pinned V8 `datacentres` layer is 4.97 km away, recorded as "Verne Global London Data Centre".
...
| measure | value |
|---|---|
| nearest transmission circuit | 0.59 km at 132 kV |
| nearest substation | 0.97 km |
| that substation, voltage | 33000 / 11000 |
| that substation, name | Montford Place Substation |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 3.17 km |
