# CDL Strata Campus Data Centre

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 48 / 100  |  OSM element `DCGB-OSM-WAY-620921953`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-620921953` |
| OSM element | https://www.openstreetmap.org/way/620921953 |
| coordinates (lat, lon) | 53.4082158, -2.1790008 |
...
element: **CDL Strata Campus Data Centre**.
...
| measure | value |
|---|---|
| nearest transmission circuit | 0.25 km at 275 kV |
| nearest substation | 1.32 km |
| that substation, voltage | 33000 / 6600 |
| that substation, name | Heaton Moor Electricity Substation |
...
| that project | Tesco Burnage Store |
| its capacity | 1 MW |
| its inferred window state | **PAST_EXPECTED_START** |
| its REPD reference | `7619` |
