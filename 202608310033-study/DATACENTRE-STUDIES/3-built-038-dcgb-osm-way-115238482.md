# DCGB-OSM-WAY-115238482

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 38 / 100  |  OSM element `DCGB-OSM-WAY-115238482`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-115238482` |
| OSM element | https://www.openstreetmap.org/way/115238482 |
| coordinates (lat, lon) | 51.4959285, -0.0183079 |
...
The nearest named point in the pinned V8 `datacentres` layer is 0.11 km away, recorded as "Digital Realty LHR19".
...
| measure | value |
|---|---|
| nearest transmission circuit | 1.40 km at 132 kV |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 0.72 km |
