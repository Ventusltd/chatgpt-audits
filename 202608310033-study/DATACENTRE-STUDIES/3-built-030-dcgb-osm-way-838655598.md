# DCGB-OSM-WAY-838655598

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 30 / 100  |  OSM element `DCGB-OSM-WAY-838655598`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-838655598` |
| OSM element | https://www.openstreetmap.org/way/838655598 |
| coordinates (lat, lon) | 51.2824757, -0.7961314 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 2.48 km at 132 kV |
| nearest substation | 0.20 km |
| that substation, voltage | 33000 |
| that substation, name | _unnamed in source_ |

Within 2.48 km of a 132 kV circuit - a workable connection distance for a load of this kind.

## 4. Generation adjacency - the pairing that matters

| measure | value |
|---|---|
| nearest live solar or BESS project | 2.64 km |
