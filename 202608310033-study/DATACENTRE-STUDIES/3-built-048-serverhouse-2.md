...
**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 48 / 100  |  OSM element `DCGB-OSM-NODE-12641413062`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-NODE-12641413062` |
| OSM element | https://www.openstreetmap.org/node/12641413062 |
| coordinates (lat, lon) | 50.8482468, -1.1664407 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 0.61 km at 132 kV |
| nearest substation | 1.62 km |
...
| that project | Tanners Lane - Battery Energy Storage Facility (Phase One) |
| its capacity | 40 MW |
| its inferred window state | **PAST_EXPECTED_START** |
| its REPD reference | `9708` |
