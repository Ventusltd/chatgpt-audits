# AWS Swindon Data Centre

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 40 / 100  |  OSM element `DCGB-OSM-NODE-11902392009`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-NODE-11902392009` |
| OSM element | https://www.openstreetmap.org/node/11902392009 |
| coordinates (lat, lon) | 51.5240279, -1.7641017 |
...
element: **AWS Swindon Data Centre**.
...
| measure | value |
|---|---|
| nearest transmission circuit | 4.74 km at 132 kV |
| nearest substation | 2.21 km |
| that substation, voltage | 33000 |
| that substation, name | _unnamed in source_ |

Within 4.74 km of a 132 kV circuit - a workable connection distance for a load of this kind.

## 4. Generation adjacency - the pairing that matters

| measure | value |
|---|---|
| nearest live solar or BESS project | 3.00 km |
| that project | Building ONE |
| its capacity | 1.2 MW |
| its inferred window state | **DESIGN_FROZEN_OR_LATER** |
| its REPD reference | `7252` |
