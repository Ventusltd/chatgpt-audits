...
**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 48 / 100  |  OSM element `DCGB-OSM-WAY-38575403`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-38575403` |
| OSM element | https://www.openstreetmap.org/way/38575403 |
| coordinates (lat, lon) | 52.8796234, -1.1449628 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 0.38 km at 400 kV |
| nearest substation | 2.58 km |
| that substation, voltage | 132000 |
| that substation, name | Fairham Substation |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 0.81 km |
| that project | Fair Oaks Renewable Energy Park - Solar farm & Battery energy storage |
| its capacity | 49.9 MW |
| its inferred window state | **PAST_EXPECTED_START** |
| its REPD reference | `9795` |
