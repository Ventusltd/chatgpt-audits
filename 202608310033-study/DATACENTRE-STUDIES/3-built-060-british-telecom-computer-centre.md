...
**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 60 / 100  |  OSM element `DCGB-OSM-WAY-190449012`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-190449012` |
| OSM element | https://www.openstreetmap.org/way/190449012 |
| coordinates (lat, lon) | 51.4856166, -0.4831024 |
...
element: **British Telecom Computer Centre**.
...
| measure | value |
|---|---|
| nearest transmission circuit | 1.04 km at 132 kV |
| nearest substation | 0.70 km |
| that substation, voltage | 33000 / 11000 |
| that substation, name | Bath Road West |
...
4.08 km of this load. Private-wire, co-location and behind-the-meter conversations are live *now*, and the
