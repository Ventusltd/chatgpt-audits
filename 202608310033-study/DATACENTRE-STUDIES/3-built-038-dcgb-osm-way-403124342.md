# DCGB-OSM-WAY-403124342

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 38 / 100  |  OSM element `DCGB-OSM-WAY-403124342`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-403124342` |
| OSM element | https://www.openstreetmap.org/way/403124342 |
| coordinates (lat, lon) | 53.7091115, -1.8848533 |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 2.39 km |
