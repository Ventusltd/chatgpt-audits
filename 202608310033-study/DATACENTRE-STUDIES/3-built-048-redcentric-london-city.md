# Redcentric London City

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 48 / 100  |  OSM element `DCGB-OSM-WAY-164527297`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-164527297` |
| OSM element | https://www.openstreetmap.org/way/164527297 |
| coordinates (lat, lon) | 51.5229321, -0.0828809 |
...
element: **Redcentric London City**.
...
| that substation, name | Finsbury Market Substation |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 4.13 km |
