...
**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 48 / 100  |  OSM element `DCGB-OSM-WAY-81633882`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-81633882` |
| OSM element | https://www.openstreetmap.org/way/81633882 |
| coordinates (lat, lon) | 51.5205153, -0.6215649 |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 3.53 km |
