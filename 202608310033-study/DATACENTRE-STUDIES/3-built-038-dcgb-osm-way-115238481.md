# DCGB-OSM-WAY-115238481

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 38 / 100  |  OSM element `DCGB-OSM-WAY-115238481`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-115238481` |
| OSM element | https://www.openstreetmap.org/way/115238481 |
| coordinates (lat, lon) | 51.494542, -0.0188761 |
...
The nearest named point in the pinned V8 `datacentres` layer is 0.26 km away, recorded as "Digital Realty LHR19".
...
| measure | value |
|---|---|
| nearest transmission circuit | 1.24 km at 132 kV |
