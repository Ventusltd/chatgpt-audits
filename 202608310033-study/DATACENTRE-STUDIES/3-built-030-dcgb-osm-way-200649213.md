# DCGB-OSM-WAY-200649213

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 30 / 100  |  OSM element `DCGB-OSM-WAY-200649213`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-200649213` |
| OSM element | https://www.openstreetmap.org/way/200649213 |
| coordinates (lat, lon) | 53.0790476, -0.7922606 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 2.96 km at 400 kV |
| nearest substation | 0.43 km |
| that substation, voltage | 33000 / 11000 |
| that substation, name | _unnamed in source_ |

Within 2.96 km of a 400 kV circuit - a workable connection distance for a load of this kind.

## 4. Generation adjacency - the pairing that matters

| measure | value |
|---|---|
| nearest live solar or BESS project | 3.98 km |
