# DCGB-OSM-WAY-30925979

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 38 / 100  |  OSM element `DCGB-OSM-WAY-30925979`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-30925979` |
| OSM element | https://www.openstreetmap.org/way/30925979 |
| coordinates (lat, lon) | 53.4205254, -2.6013747 |
...
The nearest named point in the pinned V8 `datacentres` layer is 1.98 km away, recorded as "Iron Mountain".
...
| that substation, name | Dallam Substation |
...
| that project | Fairchild Road, Burtonwood & Westbrook - Solar Panels |
| its capacity | 1.00035 MW |
| its inferred window state | **PAST_EXPECTED_START** |
| its REPD reference | `14452` |
