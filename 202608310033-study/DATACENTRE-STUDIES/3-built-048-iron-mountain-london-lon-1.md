# Iron Mountain London LON-1

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 48 / 100  |  OSM element `DCGB-OSM-WAY-393243674`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-393243674` |
| OSM element | https://www.openstreetmap.org/way/393243674 |
| coordinates (lat, lon) | 51.5267957, -0.6333195 |
...
element: **Iron Mountain London LON-1**.
...
| measure | value |
|---|---|
| nearest transmission circuit | 0.78 km at 132 kV |
