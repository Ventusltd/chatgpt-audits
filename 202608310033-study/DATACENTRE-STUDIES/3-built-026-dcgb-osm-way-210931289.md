# DCGB-OSM-WAY-210931289

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 26 / 100  |  OSM element `DCGB-OSM-WAY-210931289`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-210931289` |
| OSM element | https://www.openstreetmap.org/way/210931289 |
| coordinates (lat, lon) | 51.4166537, -0.7585502 |
...
The nearest named point in the pinned V8 `datacentres` layer is 1.65 km away, recorded as "Amazon Web Services".
...
| measure | value |
|---|---|
| nearest transmission circuit | 2.67 km at 132 kV |
| nearest substation | 0.41 km |
| that substation, voltage | 132000 / 33000 / 11000 |
| that substation, name | Bracknell Substation |

Within 2.67 km of a 132 kV circuit - a workable connection distance for a load of this kind.

## 4. Generation adjacency - the pairing that matters

| measure | value |
|---|---|
| nearest live solar or BESS project | 5.93 km |
| that project | Billingbear Solar Farm |
| its capacity | 21.505 MW |
| its inferred window state | **PAST_EXPECTED_START** |
| its REPD reference | `12584` |
