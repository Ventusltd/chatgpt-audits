...
**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 40 / 100  |  OSM element `DCGB-OSM-NODE-12303136064`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-NODE-12303136064` |
| OSM element | https://www.openstreetmap.org/node/12303136064 |
| coordinates (lat, lon) | 53.4615004, -2.2377018 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 4.63 km at 132 kV |
| nearest substation | 1.61 km |
| that substation, voltage | 132000 |
| that substation, name | BLOOM ST GRID |

Within 4.63 km of a 132 kV circuit - a workable connection distance for a load of this kind.

## 4. Generation adjacency - the pairing that matters

| measure | value |
|---|---|
| nearest live solar or BESS project | 3.66 km |
