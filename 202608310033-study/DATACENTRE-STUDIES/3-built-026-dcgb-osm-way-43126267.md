# DCGB-OSM-WAY-43126267

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 26 / 100  |  OSM element `DCGB-OSM-WAY-43126267`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-43126267` |
| OSM element | https://www.openstreetmap.org/way/43126267 |
| coordinates (lat, lon) | 51.6514619, -0.1503563 |
...
The nearest named point in the pinned V8 `datacentres` layer is 6.55 km away, recorded as "Virtus LONDON1".
...
| measure | value |
|---|---|
| nearest transmission circuit | 3.44 km at 275 kV |
| nearest substation | 0.84 km |
| that substation, voltage | 33000 / 11000 |
| that substation, name | _unnamed in source_ |

Within 3.44 km of a 275 kV circuit - a workable connection distance for a load of this kind.

## 4. Generation adjacency - the pairing that matters

| measure | value |
|---|---|
| nearest live solar or BESS project | 5.65 km |
| that project | Mill Hill National Grid Substation |
| its capacity | 49.9 MW |
| its inferred window state | **PAST_EXPECTED_START** |
| its REPD reference | `8009` |
