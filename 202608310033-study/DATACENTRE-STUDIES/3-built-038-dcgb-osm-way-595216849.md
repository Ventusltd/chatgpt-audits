# DCGB-OSM-WAY-595216849

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 38 / 100  |  OSM element `DCGB-OSM-WAY-595216849`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-595216849` |
| OSM element | https://www.openstreetmap.org/way/595216849 |
| coordinates (lat, lon) | 51.7620214, -0.4364535 |
...
The nearest named point in the pinned V8 `datacentres` layer is 0.28 km away, recorded as "NTT".
...
| measure | value |
|---|---|
| nearest transmission circuit | 1.62 km at 400 kV |
| nearest substation | 0.24 km |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 0.46 km |
| that project | G Park Maxted Road - Solar Panels |
| its capacity | 1.25 MW |
| its inferred window state | **PAST_EXPECTED_START** |
| its REPD reference | `11472` |
