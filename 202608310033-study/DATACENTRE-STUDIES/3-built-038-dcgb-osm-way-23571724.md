# DCGB-OSM-WAY-23571724

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 38 / 100  |  OSM element `DCGB-OSM-WAY-23571724`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-23571724` |
| OSM element | https://www.openstreetmap.org/way/23571724 |
| coordinates (lat, lon) | 51.3845572, -0.1374049 |
...
| that substation, name | Prologis Substation |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 3.64 km |
