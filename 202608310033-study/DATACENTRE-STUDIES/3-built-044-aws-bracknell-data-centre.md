# AWS Bracknell Data Centre

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 44 / 100  |  OSM element `DCGB-OSM-NODE-11902288339`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-NODE-11902288339` |
| OSM element | https://www.openstreetmap.org/node/11902288339 |
| coordinates (lat, lon) | 51.4138607, -0.7820534 |
...
element: **AWS Bracknell Data Centre**.
...
| measure | value |
|---|---|
| nearest transmission circuit | 1.07 km at 132 kV |
