# DCGB-OSM-WAY-166184193

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 38 / 100  |  OSM element `DCGB-OSM-WAY-166184193`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-166184193` |
| OSM element | https://www.openstreetmap.org/way/166184193 |
| coordinates (lat, lon) | 51.5515096, -1.8471367 |
...
The nearest named point in the pinned V8 `datacentres` layer is 2.41 km away, recorded as "Nationwide Swindon Technology Centre".
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 0.71 km |
| that project | Park Farm |
| its capacity | 10 MW |
| its inferred window state | **DISTRESSED** |
| its REPD reference | `7983` |

A live generation project is close, but it is not in the commercial window (DISTRESSED). Note the adjacency and
