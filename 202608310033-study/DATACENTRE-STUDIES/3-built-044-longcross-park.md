...
**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 44 / 100  |  OSM element `DCGB-OSM-WAY-1481166632`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-1481166632` |
| OSM element | https://www.openstreetmap.org/way/1481166632 |
| coordinates (lat, lon) | 51.3805356, -0.5946346 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 1.46 km at 400 kV |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 5.27 km |
| that project | Mclaren Technology Centre, Chertsey Road - Solar Panels |
| its capacity | 2.556 MW |
| its inferred window state | **PAST_EXPECTED_START** |
| its REPD reference | `19536` |
