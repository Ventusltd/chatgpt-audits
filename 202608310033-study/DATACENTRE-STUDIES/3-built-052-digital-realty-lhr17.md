# Digital Realty LHR17

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 52 / 100  |  OSM element `DCGB-OSM-WAY-23439047`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-23439047` |
| OSM element | https://www.openstreetmap.org/way/23439047 |
| coordinates (lat, lon) | 51.4816653, -0.4603496 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 2.68 km at 132 kV |
| nearest substation | 0.89 km |
| that substation, voltage | 33000 |
| that substation, name | _unnamed in source_ |

Within 2.68 km of a 132 kV circuit - a workable connection distance for a load of this kind.
...
3.48 km of this load. Private-wire, co-location and behind-the-meter conversations are live *now*, and the
