# DCGB-OSM-WAY-1268715673

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 30 / 100  |  OSM element `DCGB-OSM-WAY-1268715673`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-1268715673` |
| OSM element | https://www.openstreetmap.org/way/1268715673 |
| coordinates (lat, lon) | 54.5959499, -5.9248945 |
...
The nearest named point in the pinned V8 `datacentres` layer is 1.02 km away, recorded as "Microsoft Ireland".
...
| measure | value |
|---|---|
| nearest transmission circuit | 4.35 km at 275 kV |
| nearest substation | 0.09 km |
| that substation, voltage | 33000 / 6000 |
| that substation, name | East Central 33 kV Substation |

Within 4.35 km of a 275 kV circuit - a workable connection distance for a load of this kind.

## 4. Generation adjacency - the pairing that matters

| measure | value |
|---|---|
| nearest live solar or BESS project | 0.34 km |
| that project | Solar PV Energy Alterations in Belfast |
| its capacity | 2 MW |
| its inferred window state | **PRE_CONSENT** |
| its REPD reference | `16445` |
