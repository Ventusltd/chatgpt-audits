# DCGB-OSM-WAY-258625769

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 38 / 100  |  OSM element `DCGB-OSM-WAY-258625769`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-258625769` |
| OSM element | https://www.openstreetmap.org/way/258625769 |
| coordinates (lat, lon) | 51.4981409, -0.0144922 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 1.39 km at 132 kV |
