# DCGB-OSM-WAY-1481464835

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 38 / 100  |  OSM element `DCGB-OSM-WAY-1481464835`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-1481464835` |
| OSM element | https://www.openstreetmap.org/way/1481464835 |
| coordinates (lat, lon) | 51.5276722, -0.2551627 |
...
The nearest named point in the pinned V8 `datacentres` layer is 0.26 km away, recorded as "Unknown Data Centre".
...
| measure | value |
|---|---|
| nearest transmission circuit | 0.37 km at 132 kV |
| nearest substation | 0.67 km |
| that substation, voltage | 132000 / 25000 / 11000 |
| that substation, name | Willesden Feeder Station |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 1.52 km |
| that project | Premier Park Road - Photovoltaic System |
| its capacity | 1.44 MW |
| its inferred window state | **PAST_EXPECTED_START** |
| its REPD reference | `10898` |
