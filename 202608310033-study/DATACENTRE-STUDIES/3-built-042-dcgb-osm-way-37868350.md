# DCGB-OSM-WAY-37868350

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 42 / 100  |  OSM element `DCGB-OSM-WAY-37868350`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-37868350` |
| OSM element | https://www.openstreetmap.org/way/37868350 |
| coordinates (lat, lon) | 51.5013691, -0.4288873 |
...
The nearest named point in the pinned V8 `datacentres` layer is 0.61 km away, recorded as "UBS Data Centre".
...
| measure | value |
|---|---|
| nearest transmission circuit | 1.24 km at 275 kV |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 6.21 km |
...
A live generation project inside the inferred commercial window sits 6.21 km away. Too far for a private wire
