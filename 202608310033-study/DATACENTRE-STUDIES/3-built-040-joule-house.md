...
**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 40 / 100  |  OSM element `DCGB-OSM-WAY-166407577`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-166407577` |
| OSM element | https://www.openstreetmap.org/way/166407577 |
| coordinates (lat, lon) | 53.4680158, -2.2934202 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 3.54 km at 275 kV |
| nearest substation | 0.80 km |
| that substation, voltage | 33000 |
| that substation, name | Chester Road Network |

Within 3.54 km of a 275 kV circuit - a workable connection distance for a load of this kind.
...
| that project | Golf Road - Battery Energy Storage |
| its capacity | 90 MW |
| its inferred window state | **PAST_EXPECTED_START** |
| its REPD reference | `13459` |
