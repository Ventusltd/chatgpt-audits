# DCGB-OSM-WAY-1543080891

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 38 / 100  |  OSM element `DCGB-OSM-WAY-1543080891`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-1543080891` |
| OSM element | https://www.openstreetmap.org/way/1543080891 |
| coordinates (lat, lon) | 51.5128133, -0.3099253 |
...
The nearest named point in the pinned V8 `datacentres` layer is 2.85 km away, recorded as "Equinix LD3".
...
| measure | value |
|---|---|
| nearest transmission circuit | 1.56 km at 275 kV |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 3.75 km |
