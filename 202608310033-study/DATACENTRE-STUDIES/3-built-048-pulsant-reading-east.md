...
**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 48 / 100  |  OSM element `DCGB-OSM-WAY-63983065`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-63983065` |
| OSM element | https://www.openstreetmap.org/way/63983065 |
| coordinates (lat, lon) | 51.4569277, -0.9414155 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 1.02 km at 132 kV |
| nearest substation | 1.02 km |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 0.00 km |
