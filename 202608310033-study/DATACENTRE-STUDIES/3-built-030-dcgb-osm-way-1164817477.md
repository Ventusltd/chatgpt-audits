# DCGB-OSM-WAY-1164817477

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 30 / 100  |  OSM element `DCGB-OSM-WAY-1164817477`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-1164817477` |
| OSM element | https://www.openstreetmap.org/way/1164817477 |
| coordinates (lat, lon) | 51.2807055, -0.7981341 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 2.66 km at 132 kV |
| nearest substation | 0.08 km |
| that substation, voltage | 33000 |
| that substation, name | _unnamed in source_ |

Within 2.66 km of a 132 kV circuit - a workable connection distance for a load of this kind.

## 4. Generation adjacency - the pairing that matters

| measure | value |
|---|---|
| nearest live solar or BESS project | 2.75 km |
