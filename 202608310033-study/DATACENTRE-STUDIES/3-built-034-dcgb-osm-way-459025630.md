# DCGB-OSM-WAY-459025630

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 34 / 100  |  OSM element `DCGB-OSM-WAY-459025630`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-459025630` |
| OSM element | https://www.openstreetmap.org/way/459025630 |
| coordinates (lat, lon) | 51.6199, -0.7790299 |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 5.95 km |
| that project | Derehams Farm, Derehams Lane - Battery Storage |
| its capacity | 126 MW |
| its inferred window state | **PRE_CONSENT** |
| its REPD reference | `12649` |
