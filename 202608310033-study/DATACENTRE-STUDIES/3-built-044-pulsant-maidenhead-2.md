...
**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 44 / 100  |  OSM element `DCGB-OSM-WAY-49602063`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-49602063` |
| OSM element | https://www.openstreetmap.org/way/49602063 |
| coordinates (lat, lon) | 51.4996939, -0.7083993 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 1.32 km at 132 kV |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 5.21 km |
| that project | Car Park Legoland Windsor Resort, Winkfield Road - PV solar photovoltaic |
| its capacity | 1.2 MW |
| its inferred window state | **PAST_EXPECTED_START** |
| its REPD reference | `15661` |
