...
**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 48 / 100  |  OSM element `DCGB-OSM-NODE-11162004018`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-NODE-11162004018` |
| OSM element | https://www.openstreetmap.org/node/11162004018 |
| coordinates (lat, lon) | 51.6293335, -3.2290026 |
...
element: **Centerprise International (Distribution)**.
...
| measure | value |
|---|---|
| nearest transmission circuit | 0.42 km at 400 kV |
| nearest substation | 3.51 km |
| that substation, voltage | 33000 / 11000 |
| that substation, name | Cwmfelinfach Primary Substation |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 3.93 km |
| that project | Cwm Ivor Penyrheol Solar Farm |
| its capacity | 20 MW |
| its inferred window state | **PAST_EXPECTED_START** |
| its REPD reference | `9398` |
