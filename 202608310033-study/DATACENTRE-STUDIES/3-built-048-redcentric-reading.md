...
**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 48 / 100  |  OSM element `DCGB-OSM-WAY-93845197`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-93845197` |
| OSM element | https://www.openstreetmap.org/way/93845197 |
| coordinates (lat, lon) | 51.4206794, -0.975228 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 1.86 km at 132 kV |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 4.28 km |
| that project | Spencers Wood Solar Farm, Basingstoke Road - Solar Array |
| its capacity | 28 MW |
| its inferred window state | **PAST_EXPECTED_START** |
| its REPD reference | `15460` |
