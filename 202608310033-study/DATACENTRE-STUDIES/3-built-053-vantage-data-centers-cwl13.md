# Vantage Data Centers - CWL13

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 53 / 100  |  OSM element `DCGB-OSM-WAY-1198641381`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-1198641381` |
| OSM element | https://www.openstreetmap.org/way/1198641381 |
| coordinates (lat, lon) | 51.554789, -3.0327479 |
...
element: **Vantage Data Centers - CWL13**.
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 2.22 km |
