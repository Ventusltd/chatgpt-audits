# Rackspace London Slough (LON3)

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 48 / 100  |  OSM element `DCGB-OSM-WAY-81633700`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-81633700` |
| OSM element | https://www.openstreetmap.org/way/81633700 |
| coordinates (lat, lon) | 51.5200864, -0.6189727 |
...
element: **Rackspace London Slough (LON3)**.
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 3.38 km |
