# Stellanor London East

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 48 / 100  |  OSM element `DCGB-OSM-WAY-100299967`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-100299967` |
| OSM element | https://www.openstreetmap.org/way/100299967 |
| coordinates (lat, lon) | 51.513946, -0.0724737 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 0.13 km at 132 kV |
| nearest substation | 0.11 km |
| that substation, voltage | 132000 / 22000 |
| that substation, name | Mansell Street BSP |
