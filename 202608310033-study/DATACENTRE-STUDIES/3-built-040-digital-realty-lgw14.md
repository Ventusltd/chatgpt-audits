# Digital Realty LGW14

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 40 / 100  |  OSM element `DCGB-OSM-WAY-34520874`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-34520874` |
| OSM element | https://www.openstreetmap.org/way/34520874 |
| coordinates (lat, lon) | 51.3238402, -0.5880547 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 4.52 km at 400 kV |
| nearest substation | 0.15 km |
| that substation, voltage | 132000 / 11000 |
| that substation, name | _unnamed in source_ |

Within 4.52 km of a 400 kV circuit - a workable connection distance for a load of this kind.

## 4. Generation adjacency - the pairing that matters

| measure | value |
|---|---|
| nearest live solar or BESS project | 0.23 km |
| that project | Kestrel Way - Solar Panels |
| its capacity | 1.47 MW |
| its inferred window state | **PAST_EXPECTED_START** |
| its REPD reference | `15780` |
