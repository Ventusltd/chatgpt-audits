...
**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 40 / 100  |  OSM element `DCGB-OSM-WAY-510493859`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-510493859` |
| OSM element | https://www.openstreetmap.org/way/510493859 |
| coordinates (lat, lon) | 51.8715292, -2.4858019 |
...
| nearest substation | 1.75 km |
| that substation, voltage | 33000 |
| that substation, name | Mitcheldean Substation |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 2.56 km |
| that project | Locquiers Farm, Plump Hill - Solar Farm |
| its capacity | 15.7 MW |
| its inferred window state | **PAST_EXPECTED_START** |
| its REPD reference | `9114` |
