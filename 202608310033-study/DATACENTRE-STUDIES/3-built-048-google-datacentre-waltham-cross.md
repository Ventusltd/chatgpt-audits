# Google Datacentre Waltham Cross

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 48 / 100  |  OSM element `DCGB-OSM-WAY-795170874`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-795170874` |
| OSM element | https://www.openstreetmap.org/way/795170874 |
| coordinates (lat, lon) | 51.6961913, -0.0488561 |
...
element: **Google Datacentre Waltham Cross**.
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 0.41 km |
| that project | St Marys C Of E Va High School, Lieutenant Ellis Way - Solar Panels |
| its capacity | 8.8 MW |
| its inferred window state | **PAST_EXPECTED_START** |
| its REPD reference | `18739` |
