# DCGB-OSM-NODE-8242627702

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 38 / 100  |  OSM element `DCGB-OSM-NODE-8242627702`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-NODE-8242627702` |
| OSM element | https://www.openstreetmap.org/node/8242627702 |
| coordinates (lat, lon) | 51.3332585, -0.7662159 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 0.95 km at 132 kV |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 0.13 km |
