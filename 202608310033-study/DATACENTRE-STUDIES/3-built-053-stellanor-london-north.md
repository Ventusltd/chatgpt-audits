...
**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 53 / 100  |  OSM element `DCGB-OSM-WAY-44107140`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-44107140` |
| OSM element | https://www.openstreetmap.org/way/44107140 |
| coordinates (lat, lon) | 51.5289786, -0.1000954 |
...
element: **Stellanor London North**.
...
| measure | value |
|---|---|
| nearest transmission circuit | 0.09 km at 132 kV |
| nearest substation | 0.33 km |
| that substation, voltage | 400000 / 132000 / 33000 / 11000 |
| that substation, name | City Road Substation |
