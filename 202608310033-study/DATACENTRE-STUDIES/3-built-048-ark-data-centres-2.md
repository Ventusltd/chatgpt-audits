...
**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 48 / 100  |  OSM element `DCGB-OSM-WAY-574135468`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-574135468` |
| OSM element | https://www.openstreetmap.org/way/574135468 |
| coordinates (lat, lon) | 51.4183627, -2.2205758 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 0.94 km at 275 kV |
| nearest substation | 0.37 km |
| that substation, voltage | 33000 / 11000 |
| that substation, name | Spring Quarry Primary Substation |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 2.73 km |
| that project | Brockleaze, Neston Park Estate - Battery Energy Storage |
| its capacity | 450 MW |
| its inferred window state | **PRE_CONSENT** |
| its REPD reference | `18670` |
