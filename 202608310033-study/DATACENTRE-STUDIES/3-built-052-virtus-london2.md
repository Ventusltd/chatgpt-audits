...
**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 52 / 100  |  OSM element `DCGB-OSM-WAY-712298673`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-712298673` |
| OSM element | https://www.openstreetmap.org/way/712298673 |
| coordinates (lat, lon) | 51.4964027, -0.4045035 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 0.60 km at 275 kV |
| nearest substation | 0.54 km |
| that substation, voltage | 66000 / 22000 / 11000 |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 6.65 km |
...
A live generation project inside the inferred commercial window sits 6.65 km away. Too far for a private wire
