# DCGB-OSM-WAY-37960145

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 38 / 100  |  OSM element `DCGB-OSM-WAY-37960145`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-37960145` |
| OSM element | https://www.openstreetmap.org/way/37960145 |
| coordinates (lat, lon) | 51.5120622, -0.58812 |
...
The nearest named point in the pinned V8 `datacentres` layer is 1.99 km away, recorded as "Kao Data KLON-06".
...
| measure | value |
|---|---|
| nearest transmission circuit | 0.52 km at 132 kV |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 2.42 km |
