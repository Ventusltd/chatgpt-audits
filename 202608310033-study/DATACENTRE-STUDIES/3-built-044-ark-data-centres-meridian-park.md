...
**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 44 / 100  |  OSM element `DCGB-OSM-WAY-131474700`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-131474700` |
| OSM element | https://www.openstreetmap.org/way/131474700 |
| coordinates (lat, lon) | 51.6195253, -0.0414604 |
...
element: **Ark Data Centres Meridian Park**.
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 6.52 km |
