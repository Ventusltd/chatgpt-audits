...
**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 48 / 100  |  OSM element `DCGB-OSM-WAY-267568325`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-267568325` |
| OSM element | https://www.openstreetmap.org/way/267568325 |
| coordinates (lat, lon) | 51.5173812, -0.0710402 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 0.04 km at 132 kV |
| nearest substation | 0.06 km |
| that substation, voltage | 132000 / 11000 |
| that substation, name | Osborn Street Substation |
