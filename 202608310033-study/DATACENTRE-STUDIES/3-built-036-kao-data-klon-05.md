...
**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 36 / 100  |  OSM element `DCGB-OSM-WAY-222789497`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-222789497` |
| OSM element | https://www.openstreetmap.org/way/222789497 |
| coordinates (lat, lon) | 51.5453478, -0.3639385 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 4.33 km at 132 kV |
| nearest substation | 1.21 km |
| that substation, voltage | 33000 / 11000 |
| that substation, name | _unnamed in source_ |

Within 4.33 km of a 132 kV circuit - a workable connection distance for a load of this kind.

## 4. Generation adjacency - the pairing that matters

| measure | value |
|---|---|
| nearest live solar or BESS project | 6.46 km |
