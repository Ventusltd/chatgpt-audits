# DCGB-OSM-WAY-87850564

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 38 / 100  |  OSM element `DCGB-OSM-WAY-87850564`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-87850564` |
| OSM element | https://www.openstreetmap.org/way/87850564 |
| coordinates (lat, lon) | 52.5558705, -0.2639381 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 0.46 km at 132 kV |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 0.53 km |
