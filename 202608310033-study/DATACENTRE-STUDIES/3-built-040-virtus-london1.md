...
**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 40 / 100  |  OSM element `DCGB-OSM-WAY-240952254`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-240952254` |
| OSM element | https://www.openstreetmap.org/way/240952254 |
| coordinates (lat, lon) | 51.6519012, -0.0553626 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 2.13 km at 275 kV |
| nearest substation | 0.11 km |
| that substation, voltage | 33000 / 11000 |
| that substation, name | East Enfield Primary |

Within 2.13 km of a 275 kV circuit - a workable connection distance for a load of this kind.

## 4. Generation adjacency - the pairing that matters

| measure | value |
|---|---|
| nearest live solar or BESS project | 3.62 km |
| that project | Iceland, Solar Way - Solar Photovoltaic Array |
| its capacity | 2.64 MW |
| its inferred window state | **PAST_EXPECTED_START** |
| its REPD reference | `15182` |
