# DCGB-OSM-WAY-431542356

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 38 / 100  |  OSM element `DCGB-OSM-WAY-431542356`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-431542356` |
| OSM element | https://www.openstreetmap.org/way/431542356 |
| coordinates (lat, lon) | 51.4611515, -0.0138038 |
...
The nearest named point in the pinned V8 `datacentres` layer is 3.98 km away, recorded as "Digital Realty LHR19".
...
| measure | value |
|---|---|
| nearest transmission circuit | 1.92 km at 400 kV |
| nearest substation | 0.70 km |
| that substation, voltage | 33000 / 750 |
| that substation, name | Lewisham DC Traction Substation |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 4.60 km |
| that project | Hedgehog Grove Solar Farm - Solar Panels |
| its capacity | 98 MW |
| its inferred window state | **PRE_CONSENT** |
| its REPD reference | `18870` |
