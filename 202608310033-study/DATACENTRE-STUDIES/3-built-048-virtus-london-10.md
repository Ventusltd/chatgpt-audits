...
**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 48 / 100  |  OSM element `DCGB-OSM-WAY-459600800`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-459600800` |
| OSM element | https://www.openstreetmap.org/way/459600800 |
| coordinates (lat, lon) | 51.5214331, -0.6209389 |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 3.45 km |
