# DCGB-OSM-WAY-658909713

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 34 / 100  |  OSM element `DCGB-OSM-WAY-658909713`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-658909713` |
| OSM element | https://www.openstreetmap.org/way/658909713 |
| coordinates (lat, lon) | 51.5048149, -0.4441576 |
...
The nearest named point in the pinned V8 `datacentres` layer is 0.27 km away, recorded as "CyrusOne LON2".
...
| measure | value |
|---|---|
| nearest transmission circuit | 2.35 km at 275 kV |
| nearest substation | 0.92 km |
| that substation, voltage | 66000 |
| that substation, name | _unnamed in source_ |

Within 2.35 km of a 275 kV circuit - a workable connection distance for a load of this kind.

## 4. Generation adjacency - the pairing that matters

| measure | value |
|---|---|
| nearest live solar or BESS project | 6.22 km |
...
A live generation project inside the inferred commercial window sits 6.22 km away. Too far for a private wire
