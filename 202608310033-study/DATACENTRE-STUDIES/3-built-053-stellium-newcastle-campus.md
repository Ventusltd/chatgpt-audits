# Stellium Newcastle Campus

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 53 / 100  |  OSM element `DCGB-OSM-WAY-749964337`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-749964337` |
| OSM element | https://www.openstreetmap.org/way/749964337 |
| coordinates (lat, lon) | 55.0171282, -1.5039339 |
...
element: **Stellium Newcastle Campus**.
...
| measure | value |
|---|---|
| nearest transmission circuit | 0.42 km at 132 kV |
| nearest substation | 0.77 km |
| that substation, voltage | 275000 |
| that substation, name | Tynemouth Substation |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 2.05 km |
| that project | Standby Embedded Stor Power Plant - Battery storage |
| its capacity | 20 MW |
| its inferred window state | **DESIGN_FROZEN_OR_LATER** |
| its REPD reference | `9010` |
