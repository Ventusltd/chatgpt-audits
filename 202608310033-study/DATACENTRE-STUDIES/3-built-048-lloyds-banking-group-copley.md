# Lloyds Banking Group Copley

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 48 / 100  |  OSM element `DCGB-OSM-WAY-147532741`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-147532741` |
| OSM element | https://www.openstreetmap.org/way/147532741 |
| coordinates (lat, lon) | 53.7084325, -1.8844483 |
...
element: **Lloyds Banking Group Copley**.
...
| measure | value |
|---|---|
| nearest transmission circuit | 0.55 km at 132 kV |
| nearest substation | 2.28 km |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 2.32 km |
| that project | Stainland Road, Salterhebble - Battery Storage Facility |
| its capacity | 25 MW |
| its inferred window state | **PAST_EXPECTED_START** |
| its REPD reference | `9397` |
