...
**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 44 / 100  |  OSM element `DCGB-OSM-WAY-460246772`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-460246772` |
| OSM element | https://www.openstreetmap.org/way/460246772 |
| coordinates (lat, lon) | 51.6428492, -0.4276473 |
...
| that substation, name | Hollywell Grid |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 5.34 km |
| that project | Langleybury Film Hub |
| its capacity | 3 MW |
| its inferred window state | **PRE_CONSENT** |
| its REPD reference | `12762` |
