# Evolution @ Agecroft Commerce Park

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 52 / 100  |  OSM element `DCGB-OSM-WAY-981640535`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-981640535` |
| OSM element | https://www.openstreetmap.org/way/981640535 |
| coordinates (lat, lon) | 53.5062901, -2.3045891 |
...
element: **Evolution @ Agecroft Commerce Park**.
...
| measure | value |
|---|---|
| nearest transmission circuit | 0.60 km at 132 kV |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 5.68 km |
| that project | Shore Top Farm, Kearsley Road - Battery Energy Storage |
| its capacity | 11 MW |
| its inferred window state | **FUNDING_WINDOW_INFERRED** |
| its REPD reference | `19074` |

A live generation project inside the inferred commercial window sits 5.68 km away. Too far for a private wire
