# DCGB-OSM-WAY-996865179

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 38 / 100  |  OSM element `DCGB-OSM-WAY-996865179`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-996865179` |
| OSM element | https://www.openstreetmap.org/way/996865179 |
| coordinates (lat, lon) | 51.4174316, -2.2194847 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 1.01 km at 275 kV |
