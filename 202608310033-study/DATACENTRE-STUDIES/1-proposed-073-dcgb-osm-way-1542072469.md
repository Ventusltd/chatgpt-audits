# DCGB-OSM-WAY-1542072469

**Verdict: WATCH - PROPOSED**  |  demand score 73 / 100  |  OSM element `DCGB-OSM-WAY-1542072469`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-1542072469` |
| OSM element | https://www.openstreetmap.org/way/1542072469 |
| coordinates (lat, lon) | 51.5306102, -0.2639709 |
...
The nearest named point in the pinned V8 `datacentres` layer is 0.46 km away, recorded as "Unknown Data Centre".
...
| measure | value |
|---|---|
| nearest transmission circuit | 0.63 km at 132 kV |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 0.86 km |
