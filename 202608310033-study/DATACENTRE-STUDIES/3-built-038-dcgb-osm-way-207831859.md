# DCGB-OSM-WAY-207831859

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 38 / 100  |  OSM element `DCGB-OSM-WAY-207831859`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-207831859` |
| OSM element | https://www.openstreetmap.org/way/207831859 |
| coordinates (lat, lon) | 53.7829395, -1.5735356 |
...
The nearest named point in the pinned V8 `datacentres` layer is 15.66 km away, recorded as "Unknown Data Centre".
...
| measure | value |
|---|---|
| nearest transmission circuit | 0.76 km at 132 kV |
| nearest substation | 1.03 km |
| that substation, voltage | 33000 / 11000 |
| that substation, name | Beeston Royds Primary |
...
| that project | Land Adjacent to 4 Redcote Lane (Armley) |
| its capacity | 49.9 MW |
| its inferred window state | **PRE_CONSENT** |
| its REPD reference | `12224` |
