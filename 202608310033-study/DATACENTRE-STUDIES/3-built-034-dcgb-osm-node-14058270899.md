# DCGB-OSM-NODE-14058270899

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 34 / 100  |  OSM element `DCGB-OSM-NODE-14058270899`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-NODE-14058270899` |
| OSM element | https://www.openstreetmap.org/node/14058270899 |
| coordinates (lat, lon) | 51.2799062, 0.5493573 |
...
The nearest named point in the pinned V8 `datacentres` layer is 0.19 km away, recorded as "CXD Infrastructure Solutions".
...
| measure | value |
|---|---|
| nearest transmission circuit | 0.68 km at 132 kV |
| nearest substation | 1.03 km |
| that substation, voltage | 33000 / 750 |
| that substation, name | Mote Park DC Traction Substation |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 9.15 km |
| that project | Phinia, Courteney Road - Solar Panels |
| its capacity | 1.82 MW |
| its inferred window state | **PAST_EXPECTED_START** |
| its REPD reference | `15469` |
