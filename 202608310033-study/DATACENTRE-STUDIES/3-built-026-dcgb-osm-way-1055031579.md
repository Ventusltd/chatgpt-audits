# DCGB-OSM-WAY-1055031579

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 26 / 100  |  OSM element `DCGB-OSM-WAY-1055031579`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-1055031579` |
| OSM element | https://www.openstreetmap.org/way/1055031579 |
| coordinates (lat, lon) | 54.5917636, -1.0320237 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 5.25 km at 400 kV |
| nearest substation | 2.15 km |
| that substation, voltage | 66000 / 11000 |
| that substation, name | Redcar Substation |

Within 5.25 km of a 400 kV circuit - a workable connection distance for a load of this kind.

## 4. Generation adjacency - the pairing that matters

| measure | value |
|---|---|
| nearest live solar or BESS project | 2.26 km |
| that project | Yearby Village - Tees Solar Farm |
| its capacity | 49.9 MW |
| its inferred window state | **PAST_EXPECTED_START** |
| its REPD reference | `9353` |
