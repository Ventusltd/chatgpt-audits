...
**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 40 / 100  |  OSM element `DCGB-OSM-NODE-9253910552`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-NODE-9253910552` |
| OSM element | https://www.openstreetmap.org/node/9253910552 |
| coordinates (lat, lon) | 57.1525691, -2.1601492 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 2.37 km at 132 kV |
| nearest substation | 0.71 km |
| that substation, voltage | 33000 / 11000 |
| that substation, name | Springhill Primary Substation |

Within 2.37 km of a 132 kV circuit - a workable connection distance for a load of this kind.

## 4. Generation adjacency - the pairing that matters

| measure | value |
|---|---|
| nearest live solar or BESS project | 1.79 km |
| that project | A981 Fraserburgh - Battery Energy Storage |
| its capacity | 25 MW |
| its inferred window state | **PAST_EXPECTED_START** |
| its REPD reference | `10222` |
