# DCGB-OSM-WAY-27618472

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 43 / 100  |  OSM element `DCGB-OSM-WAY-27618472`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-27618472` |
| OSM element | https://www.openstreetmap.org/way/27618472 |
| coordinates (lat, lon) | 51.5292302, -0.2730223 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 1.22 km at 132 kV |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 0.83 km |
