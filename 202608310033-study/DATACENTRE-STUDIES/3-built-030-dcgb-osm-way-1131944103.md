# DCGB-OSM-WAY-1131944103

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 30 / 100  |  OSM element `DCGB-OSM-WAY-1131944103`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-1131944103` |
| OSM element | https://www.openstreetmap.org/way/1131944103 |
| coordinates (lat, lon) | 54.5785009, -1.2350678 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 2.29 km at 132 kV |
| nearest substation | 1.33 km |
| that substation, voltage | 66000 / 11000 |
| that substation, name | Faraday Street |

Within 2.29 km of a 132 kV circuit - a workable connection distance for a load of this kind.

## 4. Generation adjacency - the pairing that matters

| measure | value |
|---|---|
| nearest live solar or BESS project | 0.99 km |
| that project | Wilton Engineering Services, Port Clarence Offshore Base - Solar Panels |
| its capacity | 1.2 MW |
| its inferred window state | **PAST_EXPECTED_START** |
| its REPD reference | `20085` |
