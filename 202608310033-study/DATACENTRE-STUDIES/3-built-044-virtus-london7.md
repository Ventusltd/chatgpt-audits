...
**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 44 / 100  |  OSM element `DCGB-OSM-WAY-705085807`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-705085807` |
| OSM element | https://www.openstreetmap.org/way/705085807 |
| coordinates (lat, lon) | 51.5108817, -0.4566535 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 2.56 km at 132 kV |
| nearest substation | 0.11 km |
| that substation, voltage | 66000 |
| that substation, name | _unnamed in source_ |

Within 2.56 km of a 132 kV circuit - a workable connection distance for a load of this kind.

## 4. Generation adjacency - the pairing that matters

| measure | value |
|---|---|
| nearest live solar or BESS project | 6.74 km |
...
A live generation project inside the inferred commercial window sits 6.74 km away. Too far for a private wire
