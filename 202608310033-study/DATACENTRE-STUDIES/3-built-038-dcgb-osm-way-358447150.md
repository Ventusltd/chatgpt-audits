# DCGB-OSM-WAY-358447150

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 38 / 100  |  OSM element `DCGB-OSM-WAY-358447150`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-358447150` |
| OSM element | https://www.openstreetmap.org/way/358447150 |
| coordinates (lat, lon) | 51.5006126, -0.011826 |
...
The nearest named point in the pinned V8 `datacentres` layer is 0.10 km away, recorded as "Digital Realty LHR20".
...
| measure | value |
|---|---|
| nearest transmission circuit | 1.10 km at 132 kV |
| nearest substation | 0.93 km |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 0.48 km |
