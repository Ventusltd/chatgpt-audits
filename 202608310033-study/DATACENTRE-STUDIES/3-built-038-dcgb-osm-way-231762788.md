# DCGB-OSM-WAY-231762788

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 38 / 100  |  OSM element `DCGB-OSM-WAY-231762788`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-231762788` |
| OSM element | https://www.openstreetmap.org/way/231762788 |
| coordinates (lat, lon) | 53.4890823, -1.492008 |
...
The nearest named point in the pinned V8 `datacentres` layer is 12.04 km away, recorded as "UoS IT Services".
...
| nearest substation | 1.86 km |
| that substation, voltage | 66000 |
| that substation, name | Tankersley 66KV |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 2.47 km |
| that project | Sherwin Williams Diversified Brands, Thorncliffe Road - Solar Panels |
| its capacity | 1.2 MW |
| its inferred window state | **PRE_CONSENT** |
| its REPD reference | `20867` |
