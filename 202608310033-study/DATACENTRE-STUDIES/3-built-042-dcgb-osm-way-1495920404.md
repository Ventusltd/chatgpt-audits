# DCGB-OSM-WAY-1495920404

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 42 / 100  |  OSM element `DCGB-OSM-WAY-1495920404`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-1495920404` |
| OSM element | https://www.openstreetmap.org/way/1495920404 |
| coordinates (lat, lon) | 51.5095591, -0.394089 |
...
The nearest named point in the pinned V8 `datacentres` layer is 1.63 km away, recorded as "VIRTUS LONDON2".
...
| measure | value |
|---|---|
| nearest transmission circuit | 1.59 km at 275 kV |
| nearest substation | 1.13 km |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 8.24 km |
...
A live generation project inside the inferred commercial window sits 8.24 km away. Too far for a private wire
