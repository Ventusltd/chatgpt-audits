...
**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 53 / 100  |  OSM element `DCGB-OSM-NODE-11167049138`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-NODE-11167049138` |
| OSM element | https://www.openstreetmap.org/node/11167049138 |
| coordinates (lat, lon) | 53.375805, -1.4793848 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 0.03 km at 275 kV |
| nearest substation | 0.13 km |
| that substation, voltage | 275000 / 33000 |
| that substation, name | Sheffield City Substation |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 3.65 km |
