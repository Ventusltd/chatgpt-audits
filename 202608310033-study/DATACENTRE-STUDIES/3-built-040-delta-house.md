...
**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 40 / 100  |  OSM element `DCGB-OSM-WAY-726129785`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-726129785` |
| OSM element | https://www.openstreetmap.org/way/726129785 |
| coordinates (lat, lon) | 53.3791499, -2.2586128 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 2.87 km at 275 kV |
| nearest substation | 2.26 km |
| that substation, voltage | 132000 |
| that substation, name | Moss Nook |

Within 2.87 km of a 275 kV circuit - a workable connection distance for a load of this kind.

## 4. Generation adjacency - the pairing that matters

| measure | value |
|---|---|
| nearest live solar or BESS project | 3.30 km |
