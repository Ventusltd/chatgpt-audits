# DCGB-OSM-NODE-13655340206

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 30 / 100  |  OSM element `DCGB-OSM-NODE-13655340206`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-NODE-13655340206` |
| OSM element | https://www.openstreetmap.org/node/13655340206 |
| coordinates (lat, lon) | 54.5514292, -1.3152153 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 3.23 km at 400 kV |
| nearest substation | 0.20 km |
| that substation, voltage | 66000 / 33000 / 11000 |
| that substation, name | Bowesfield |

Within 3.23 km of a 400 kV circuit - a workable connection distance for a load of this kind.

## 4. Generation adjacency - the pairing that matters

| measure | value |
|---|---|
| nearest live solar or BESS project | 0.60 km |
| that project | Bowesfield Flexible Energy Park |
| its capacity | 8 MW |
| its inferred window state | **PAST_EXPECTED_START** |
| its REPD reference | `8399` |
