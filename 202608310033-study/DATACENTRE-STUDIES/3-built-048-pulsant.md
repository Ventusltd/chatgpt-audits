...
**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 48 / 100  |  OSM element `DCGB-OSM-WAY-96173979`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-96173979` |
| OSM element | https://www.openstreetmap.org/way/96173979 |
| coordinates (lat, lon) | 51.4448808, -0.9758992 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 0.53 km at 132 kV |
| nearest substation | 1.02 km |
| that substation, voltage | 33000 |
| that substation, name | The Mall Substation |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 2.74 km |
