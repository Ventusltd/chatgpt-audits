...
**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 40 / 100  |  OSM element `DCGB-OSM-WAY-179698364`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-179698364` |
| OSM element | https://www.openstreetmap.org/way/179698364 |
| coordinates (lat, lon) | 51.8078965, -0.1864269 |
...
element: **Hertfordshire Data Centre**.
...
| measure | value |
|---|---|
| nearest transmission circuit | 2.74 km at 132 kV |
| nearest substation | 0.88 km |
| that substation, voltage | 33000 |
| that substation, name | Central Welwyn Primary |

Within 2.74 km of a 132 kV circuit - a workable connection distance for a load of this kind.

## 4. Generation adjacency - the pairing that matters

| measure | value |
|---|---|
| nearest live solar or BESS project | 0.91 km |
