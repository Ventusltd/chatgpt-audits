# Pulsant Edinburgh South Gyle SC-1

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 53 / 100  |  OSM element `DCGB-OSM-WAY-37943653`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-37943653` |
| OSM element | https://www.openstreetmap.org/way/37943653 |
| coordinates (lat, lon) | 55.9296911, -3.2938083 |
...
element: **Pulsant Edinburgh South Gyle SC-1**.
...
| measure | value |
|---|---|
| nearest transmission circuit | 0.72 km at 275 kV |
| nearest substation | 0.72 km |
| that substation, voltage | 275000 / 33000 |
| that substation, name | Sighthilll Substation |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 3.36 km |
