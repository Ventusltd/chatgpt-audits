...
**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 52 / 100  |  OSM element `DCGB-OSM-WAY-459589221`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-459589221` |
| OSM element | https://www.openstreetmap.org/way/459589221 |
| coordinates (lat, lon) | 51.5067717, -0.4271464 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 1.35 km at 275 kV |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 6.81 km |
...
A live generation project inside the inferred commercial window sits 6.81 km away. Too far for a private wire
