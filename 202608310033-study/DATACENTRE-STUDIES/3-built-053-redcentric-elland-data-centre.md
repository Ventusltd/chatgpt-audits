# Redcentric Elland Data Centre

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 53 / 100  |  OSM element `DCGB-OSM-WAY-202085268`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-202085268` |
| OSM element | https://www.openstreetmap.org/way/202085268 |
| coordinates (lat, lon) | 53.6938856, -1.8214237 |
...
element: **Redcentric Elland Data Centre**.
...
| measure | value |
|---|---|
| nearest transmission circuit | 0.07 km at 132 kV |
...
| that project | Lowfields Energy Storage Project |
| its capacity | 49.9 MW |
| its inferred window state | **PAST_EXPECTED_START** |
| its REPD reference | `10236` |
