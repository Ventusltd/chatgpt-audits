# DCGB-OSM-WAY-1535147042

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 38 / 100  |  OSM element `DCGB-OSM-WAY-1535147042`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-1535147042` |
| OSM element | https://www.openstreetmap.org/way/1535147042 |
| coordinates (lat, lon) | 53.4499653, -2.3706219 |
...
The nearest named point in the pinned V8 `datacentres` layer is 5.49 km away, recorded as "Joule House".
...
| measure | value |
|---|---|
| nearest transmission circuit | 1.42 km at 132 kV |
| nearest substation | 1.96 km |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 1.88 km |
| that project | Wild Fowl Farm, Carrington Lane - Battery Storage Facility |
| its capacity | 35 MW |
| its inferred window state | **CONSENTED_NO_DATE** |
| its REPD reference | `16383` |
