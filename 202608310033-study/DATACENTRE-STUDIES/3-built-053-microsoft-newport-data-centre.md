# Microsoft Newport data centre

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 53 / 100  |  OSM element `DCGB-OSM-WAY-1213266502`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-1213266502` |
| OSM element | https://www.openstreetmap.org/way/1213266502 |
| coordinates (lat, lon) | 51.5509775, -3.0404591 |
...
element: **Microsoft Newport data centre**.
...
| measure | value |
|---|---|
| nearest transmission circuit | 0.43 km at 400 kV |
| nearest substation | 0.74 km |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 2.19 km |
| that project | Wentlooge Renewable Energy Hub |
| its capacity | 125 MW |
| its inferred window state | **PRE_CONSENT** |
| its REPD reference | `11279` |
