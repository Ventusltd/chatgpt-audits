# Vantage Data Centers - CWL1

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 53 / 100  |  OSM element `DCGB-OSM-WAY-26794336`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-26794336` |
| OSM element | https://www.openstreetmap.org/way/26794336 |
| coordinates (lat, lon) | 51.5554234, -3.0373944 |
...
element: **Vantage Data Centers - CWL1**.
...
| measure | value |
|---|---|
| nearest transmission circuit | 0.79 km at 400 kV |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 2.51 km |
