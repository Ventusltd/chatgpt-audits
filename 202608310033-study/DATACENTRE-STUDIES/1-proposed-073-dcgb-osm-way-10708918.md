# DCGB-OSM-WAY-10708918

**Verdict: WATCH - PROPOSED**  |  demand score 73 / 100  |  OSM element `DCGB-OSM-WAY-10708918`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-10708918` |
| OSM element | https://www.openstreetmap.org/way/10708918 |
| coordinates (lat, lon) | 51.5381125, -0.2690946 |
...
The nearest named point in the pinned V8 `datacentres` layer is 0.68 km away, recorded as "Unknown Data Centre".
...
| measure | value |
|---|---|
| nearest transmission circuit | 0.81 km at 132 kV |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 0.24 km |
