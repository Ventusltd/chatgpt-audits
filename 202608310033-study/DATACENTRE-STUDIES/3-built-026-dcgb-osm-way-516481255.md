# DCGB-OSM-WAY-516481255

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 26 / 100  |  OSM element `DCGB-OSM-WAY-516481255`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-516481255` |
| OSM element | https://www.openstreetmap.org/way/516481255 |
| coordinates (lat, lon) | 51.4129104, -0.7654248 |
...
The nearest named point in the pinned V8 `datacentres` layer is 1.15 km away, recorded as "Amazon Web Services".
...
| measure | value |
|---|---|
| nearest transmission circuit | 2.09 km at 132 kV |
| nearest substation | 0.49 km |
| that substation, voltage | 132000 / 33000 / 11000 |
| that substation, name | Bracknell Substation |

Within 2.09 km of a 132 kV circuit - a workable connection distance for a load of this kind.

## 4. Generation adjacency - the pairing that matters

| measure | value |
|---|---|
| nearest live solar or BESS project | 6.02 km |
