...
**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 60 / 100  |  OSM element `DCGB-OSM-WAY-1270223634`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-1270223634` |
| OSM element | https://www.openstreetmap.org/way/1270223634 |
| coordinates (lat, lon) | 51.6173524, -1.2615655 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 0.83 km at 400 kV |
| nearest substation | 0.83 km |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 2.10 km |
...
2.10 km of this load. Private-wire, co-location and behind-the-meter conversations are live *now*, and the
