...
**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 44 / 100  |  OSM element `DCGB-OSM-WAY-44610344`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-44610344` |
| OSM element | https://www.openstreetmap.org/way/44610344 |
| coordinates (lat, lon) | 51.4666236, -0.3963834 |
...
element: **Morgan Stanley Data Centre**.
...
| measure | value |
|---|---|
| nearest transmission circuit | 3.84 km at 275 kV |
| nearest substation | 1.35 km |
| that substation, voltage | 33000 / 11000 |
| that substation, name | _unnamed in source_ |

Within 3.84 km of a 275 kV circuit - a workable connection distance for a load of this kind.
