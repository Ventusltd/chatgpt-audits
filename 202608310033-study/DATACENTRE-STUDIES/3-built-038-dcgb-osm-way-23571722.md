# DCGB-OSM-WAY-23571722

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 38 / 100  |  OSM element `DCGB-OSM-WAY-23571722`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-23571722` |
| OSM element | https://www.openstreetmap.org/way/23571722 |
| coordinates (lat, lon) | 51.3839823, -0.1359021 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 0.28 km at 275 kV |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 3.55 km |
