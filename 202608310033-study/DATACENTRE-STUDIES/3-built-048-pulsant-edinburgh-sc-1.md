# Pulsant Edinburgh SC-1

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 48 / 100  |  OSM element `DCGB-OSM-RELATION-18217492`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-RELATION-18217492` |
| OSM element | https://www.openstreetmap.org/relation/18217492 |
| coordinates (lat, lon) | 55.9297598, -3.2933933 |
...
element: **Pulsant Edinburgh SC-1**.
...
| measure | value |
|---|---|
| nearest transmission circuit | 0.75 km at 275 kV |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 3.37 km |
