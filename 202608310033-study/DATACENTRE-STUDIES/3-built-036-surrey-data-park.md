...
**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 36 / 100  |  OSM element `DCGB-OSM-WAY-713651005`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-713651005` |
| OSM element | https://www.openstreetmap.org/way/713651005 |
| coordinates (lat, lon) | 51.1864311, -0.6019958 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 7.34 km at 132 kV |
| nearest substation | 1.10 km |
| that substation, voltage | 33000 |
| that substation, name | _unnamed in source_ |

Within 7.34 km of a 132 kV circuit - a workable connection distance for a load of this kind.
...
| that project | Tuesley Farm, Tuesley Lane - Solar Array |
| its capacity | 1 MW |
| its inferred window state | **PAST_EXPECTED_START** |
| its REPD reference | `14628` |
