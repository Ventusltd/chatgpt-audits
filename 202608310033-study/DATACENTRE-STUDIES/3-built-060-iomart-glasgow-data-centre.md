# iomart Glasgow Data Centre

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 60 / 100  |  OSM element `DCGB-OSM-WAY-133868759`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-133868759` |
| OSM element | https://www.openstreetmap.org/way/133868759 |
| coordinates (lat, lon) | 55.8511347, -4.2835487 |
...
element: **iomart Glasgow Data Centre**.
...
| measure | value |
|---|---|
| nearest transmission circuit | 1.38 km at 132 kV |
| nearest substation | 1.38 km |
| that substation, voltage | 132000 / 33000 |
| that substation, name | Finnieston Substation |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 1.93 km |
| that project | Broomloan Road - Battery Energy Storage |
| its capacity | 49.9 MW |
| its inferred window state | **PROCURING_INFERRED** |
| its REPD reference | `17129` |

**This is the high-value case.** A live generation project inside the inferred commercial window sits within
1.93 km of this load. Private-wire, co-location and behind-the-meter conversations are live *now*, and the
