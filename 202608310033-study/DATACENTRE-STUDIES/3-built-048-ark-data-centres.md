...
**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 48 / 100  |  OSM element `DCGB-OSM-WAY-574135457`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-574135457` |
| OSM element | https://www.openstreetmap.org/way/574135457 |
| coordinates (lat, lon) | 51.4187452, -2.2185032 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 0.85 km at 275 kV |
| nearest substation | 0.52 km |
