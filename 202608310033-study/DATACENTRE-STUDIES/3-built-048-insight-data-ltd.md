...
**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 48 / 100  |  OSM element `DCGB-OSM-NODE-10029665515`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-NODE-10029665515` |
| OSM element | https://www.openstreetmap.org/node/10029665515 |
| coordinates (lat, lon) | 51.3580017, -2.9105618 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 0.25 km at 132 kV |
| nearest substation | 0.90 km |
| that substation, voltage | 33000 / 11000 |
| that substation, name | Lypstone Farm Primary Substation |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 2.70 km |
| that project | Manor Farm, Wick Lane - Solar Farm & Battery Storage |
| its capacity | 49.9 MW |
| its inferred window state | **PRE_CONSENT** |
| its REPD reference | `14332` |
