# Telefonica Data Centre

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 48 / 100  |  OSM element `DCGB-OSM-WAY-225909384`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-225909384` |
| OSM element | https://www.openstreetmap.org/way/225909384 |
| coordinates (lat, lon) | 51.5249468, -0.6378088 |
...
element: **Telefonica Data Centre**.
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 4.48 km |
