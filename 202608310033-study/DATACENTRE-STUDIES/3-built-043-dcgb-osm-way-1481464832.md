# DCGB-OSM-WAY-1481464832

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 43 / 100  |  OSM element `DCGB-OSM-WAY-1481464832`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-1481464832` |
| OSM element | https://www.openstreetmap.org/way/1481464832 |
| coordinates (lat, lon) | 51.532972, -0.2592311 |
...
The nearest named point in the pinned V8 `datacentres` layer is 0.16 km away, recorded as "Equinix LD9".
...
| measure | value |
|---|---|
| nearest transmission circuit | 0.23 km at 132 kV |
| nearest substation | 0.13 km |
| that substation, voltage | 400000 / 275000 / 132000 / 22000 |
| that substation, name | Willesden Substation |
