...
**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 48 / 100  |  OSM element `DCGB-OSM-NODE-11064014638`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-NODE-11064014638` |
| OSM element | https://www.openstreetmap.org/node/11064014638 |
| coordinates (lat, lon) | 53.3808925, -1.4850823 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 0.48 km at 275 kV |
| nearest substation | 0.22 km |
| that substation, voltage | 33000 |
| that substation, name | Victoria Street Substation |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 3.50 km |
| that project | Petre Street |
| its capacity | 20 MW |
| its inferred window state | **DISTRESSED** |
| its REPD reference | `6887` |
