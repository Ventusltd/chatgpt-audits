...
**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 48 / 100  |  OSM element `DCGB-OSM-WAY-15516422`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-15516422` |
| OSM element | https://www.openstreetmap.org/way/15516422 |
| coordinates (lat, lon) | 50.9616793, -1.4273241 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 1.04 km at 400 kV |
| nearest substation | 2.55 km |
| that substation, voltage | 132000 |
| that substation, name | Templars Way |
...
| that project | Misslebrook Farm, Botley Road - Battery Storage |
| its capacity | 60 MW |
| its inferred window state | **PAST_EXPECTED_START** |
| its REPD reference | `12691` |
