# DCGB-OSM-WAY-49695385

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 26 / 100  |  OSM element `DCGB-OSM-WAY-49695385`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-49695385` |
| OSM element | https://www.openstreetmap.org/way/49695385 |
| coordinates (lat, lon) | 51.5287467, -0.7254074 |
...
The nearest named point in the pinned V8 `datacentres` layer is 3.38 km away, recorded as "Pulsant Maidenhead".
...
| measure | value |
|---|---|
| nearest transmission circuit | 3.34 km at 132 kV |
| nearest substation | 1.24 km |
| that substation, voltage | 33000 / 11000 |
| that substation, name | _unnamed in source_ |

Within 3.34 km of a 132 kV circuit - a workable connection distance for a load of this kind.

## 4. Generation adjacency - the pairing that matters

| measure | value |
|---|---|
| nearest live solar or BESS project | 6.13 km |
| that project | Horizon, Hurley - Solar Panels |
| its capacity | 1.325 MW |
| its inferred window state | **PRE_CONSENT** |
| its REPD reference | `12039` |
