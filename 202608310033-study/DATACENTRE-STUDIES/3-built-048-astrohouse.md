...
**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 48 / 100  |  OSM element `DCGB-OSM-WAY-28073975`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-28073975` |
| OSM element | https://www.openstreetmap.org/way/28073975 |
| coordinates (lat, lon) | 50.8679793, -1.246002 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 0.63 km at 400 kV |
| nearest substation | 0.97 km |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 0.40 km |
