# Digital Realty LHR26

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 48 / 100  |  OSM element `DCGB-OSM-WAY-447245008`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-447245008` |
| OSM element | https://www.openstreetmap.org/way/447245008 |
| coordinates (lat, lon) | 51.516456, -0.6179162 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 0.18 km at 132 kV |
