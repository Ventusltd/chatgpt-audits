# DCGB-OSM-WAY-989525011

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 38 / 100  |  OSM element `DCGB-OSM-WAY-989525011`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-989525011` |
| OSM element | https://www.openstreetmap.org/way/989525011 |
| coordinates (lat, lon) | 51.7572082, -0.4292808 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 1.38 km at 400 kV |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 0.54 km |
| that project | Amazon Boundary Way |
| its capacity | 2 MW |
| its inferred window state | **DISTRESSED** |
| its REPD reference | `7250` |
