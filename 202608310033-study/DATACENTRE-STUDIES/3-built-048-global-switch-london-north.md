...
**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 48 / 100  |  OSM element `DCGB-OSM-WAY-196783604`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-196783604` |
| OSM element | https://www.openstreetmap.org/way/196783604 |
| coordinates (lat, lon) | 51.511119, -0.005573 |
...
element: **Global Switch London North**.
