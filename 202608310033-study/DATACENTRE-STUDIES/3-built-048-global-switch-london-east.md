...
**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 48 / 100  |  OSM element `DCGB-OSM-WAY-157178049`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-157178049` |
| OSM element | https://www.openstreetmap.org/way/157178049 |
| coordinates (lat, lon) | 51.5109396, -0.003425 |
...
element: **Global Switch London East**.
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 1.39 km |
