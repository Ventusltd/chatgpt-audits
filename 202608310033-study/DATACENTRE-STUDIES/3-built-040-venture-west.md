...
**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 40 / 100  |  OSM element `DCGB-OSM-WAY-460206687`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-460206687` |
| OSM element | https://www.openstreetmap.org/way/460206687 |
| coordinates (lat, lon) | 51.3770297, -1.2904722 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 3.89 km at 132 kV |
| nearest substation | 0.46 km |
| that substation, voltage | 33000 |
| that substation, name | _unnamed in source_ |

Within 3.89 km of a 132 kV circuit - a workable connection distance for a load of this kind.

## 4. Generation adjacency - the pairing that matters

| measure | value |
|---|---|
| nearest live solar or BESS project | 4.10 km |
| that project | Strattons Farm, Newbury Road - Solar PV Farm |
| its capacity | 23 MW |
| its inferred window state | **PRE_CONSENT** |
| its REPD reference | `15524` |
