# Datum Farnborough Data Centre

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 40 / 100  |  OSM element `DCGB-OSM-RELATION-6796887`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-RELATION-6796887` |
| OSM element | https://www.openstreetmap.org/relation/6796887 |
| coordinates (lat, lon) | 51.2805849, -0.7960565 |
...
element: **Datum Farnborough Data Centre**.
...
| measure | value |
|---|---|
| nearest transmission circuit | 2.69 km at 132 kV |
| nearest substation | 0.07 km |
| that substation, voltage | 33000 |
| that substation, name | _unnamed in source_ |

Within 2.69 km of a 132 kV circuit - a workable connection distance for a load of this kind.

## 4. Generation adjacency - the pairing that matters

| measure | value |
|---|---|
| nearest live solar or BESS project | 2.60 km |
| that project | Farnborough International Exhibition Centre, Etps Road - Solar Panels |
| its capacity | 1.15 MW |
| its inferred window state | **DESIGN_FROZEN_OR_LATER** |
| its REPD reference | `15581` |

A live generation project is close, but it is not in the commercial window (DESIGN_FROZEN_OR_LATER). Note the adjacency and
