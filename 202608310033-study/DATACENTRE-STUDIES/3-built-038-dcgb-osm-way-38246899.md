# DCGB-OSM-WAY-38246899

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 38 / 100  |  OSM element `DCGB-OSM-WAY-38246899`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-38246899` |
| OSM element | https://www.openstreetmap.org/way/38246899 |
| coordinates (lat, lon) | 51.5706229, -0.2371879 |
...
The nearest named point in the pinned V8 `datacentres` layer is 0.51 km away, recorded as "LDeX 1".
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 4.47 km |
