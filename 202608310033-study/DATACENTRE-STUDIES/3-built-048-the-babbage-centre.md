...
**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 48 / 100  |  OSM element `DCGB-OSM-WAY-32295873`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-32295873` |
| OSM element | https://www.openstreetmap.org/way/32295873 |
| coordinates (lat, lon) | 53.3226483, -2.7340658 |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 1.62 km |
| that project | Cholmondeley Road - Battery Storage |
| its capacity | 150 MW |
| its inferred window state | **PAST_EXPECTED_START** |
| its REPD reference | `9763` |
