# Digital Realty LGW16

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 44 / 100  |  OSM element `DCGB-OSM-WAY-587679709`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-587679709` |
| OSM element | https://www.openstreetmap.org/way/587679709 |
| coordinates (lat, lon) | 51.12907, -0.176786 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 1.11 km at 132 kV |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 10.07 km |
