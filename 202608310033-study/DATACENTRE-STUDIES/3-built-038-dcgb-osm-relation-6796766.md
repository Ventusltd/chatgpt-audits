# DCGB-OSM-RELATION-6796766

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 38 / 100  |  OSM element `DCGB-OSM-RELATION-6796766`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-RELATION-6796766` |
| OSM element | https://www.openstreetmap.org/relation/6796766 |
| coordinates (lat, lon) | 51.4373456, -0.8873807 |
...
The nearest named point in the pinned V8 `datacentres` layer is 4.33 km away, recorded as "Pulsant Reading East".
...
| measure | value |
|---|---|
| nearest transmission circuit | 0.35 km at 132 kV |
| nearest substation | 0.29 km |
| that substation, voltage | 33000 / 750 |
| that substation, name | Winnersh DC Traction Substation |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 4.33 km |
| that project | Suttons Park Avenue, Suttons Business Park - Solar PV |
| its capacity | 1.301 MW |
| its inferred window state | **PAST_EXPECTED_START** |
| its REPD reference | `14323` |
