...
**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 48 / 100  |  OSM element `DCGB-OSM-NODE-7829977772`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-NODE-7829977772` |
| OSM element | https://www.openstreetmap.org/node/7829977772 |
| coordinates (lat, lon) | 52.230127, 0.1508622 |
...
| that substation, name | Milton Road Primary |
...
| that project | Low Fen, Drove Way - Solar Farm |
| its capacity | 49.99 MW |
| its inferred window state | **PRE_CONSENT** |
| its REPD reference | `17360` |
