# DCGB-OSM-NODE-14062735949

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 38 / 100  |  OSM element `DCGB-OSM-NODE-14062735949`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-NODE-14062735949` |
| OSM element | https://www.openstreetmap.org/node/14062735949 |
| coordinates (lat, lon) | 51.4944095, -0.27361 |
...
The nearest named point in the pinned V8 `datacentres` layer is 3.84 km away, recorded as "Equinix LD3".
...
| measure | value |
|---|---|
| nearest transmission circuit | 1.75 km at 275 kV |
| nearest substation | 0.66 km |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 4.70 km |
