# DCGB-OSM-WAY-713940435

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 38 / 100  |  OSM element `DCGB-OSM-WAY-713940435`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-713940435` |
| OSM element | https://www.openstreetmap.org/way/713940435 |
| coordinates (lat, lon) | 51.3330613, -0.7668328 |
...
The nearest named point in the pinned V8 `datacentres` layer is 0.05 km away, recorded as "Unknown Data Centre".
...
| measure | value |
|---|---|
| nearest transmission circuit | 0.94 km at 132 kV |
| nearest substation | 0.75 km |
| that substation, voltage | 132000 / 33000 |
| that substation, name | Camberley Substation |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 0.16 km |
| that project | Data Centre, Dennison House, Stanhope Road - Solar Panels |
| its capacity | 1.222 MW |
| its inferred window state | **PRE_CONSENT** |
| its REPD reference | `17628` |
