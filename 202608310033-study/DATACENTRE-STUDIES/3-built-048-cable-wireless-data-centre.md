...
**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 48 / 100  |  OSM element `DCGB-OSM-WAY-190297843`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-190297843` |
| OSM element | https://www.openstreetmap.org/way/190297843 |
| coordinates (lat, lon) | 51.502005, -0.0091155 |
...
element: **Cable & Wireless Data Centre**.
...
| measure | value |
|---|---|
| nearest transmission circuit | 0.87 km at 132 kV |
| nearest substation | 0.73 km |
| that substation, voltage | 132000 |
| that substation, name | Blackwall Way Substation |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 0.63 km |
