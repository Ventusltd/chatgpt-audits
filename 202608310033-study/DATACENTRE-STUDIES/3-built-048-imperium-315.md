...
**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 48 / 100  |  OSM element `DCGB-OSM-WAY-460956016`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-460956016` |
| OSM element | https://www.openstreetmap.org/way/460956016 |
| coordinates (lat, lon) | 51.5866746, 0.4848784 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 0.88 km at 132 kV |
| nearest substation | 0.23 km |
| that substation, voltage | 33000 / 11000 |
| that substation, name | Gardiners Lane |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 3.96 km |
| that project | Rayleigh Spur Roundabout, Benfleet - Battery Energy Storage System |
| its capacity | 150 MW |
| its inferred window state | **PRE_CONSENT** |
| its REPD reference | `18649` |
