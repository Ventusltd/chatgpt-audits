# IP House London Datacentre

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 53 / 100  |  OSM element `DCGB-OSM-WAY-270023895`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-270023895` |
| OSM element | https://www.openstreetmap.org/way/270023895 |
| coordinates (lat, lon) | 51.515406, 0.0019607 |
...
element: **IP House London Datacentre**.
...
| measure | value |
|---|---|
| nearest transmission circuit | 0.27 km at 132 kV |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 2.01 km |
