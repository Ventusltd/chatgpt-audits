...
**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 48 / 100  |  OSM element `DCGB-OSM-WAY-958673591`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-958673591` |
| OSM element | https://www.openstreetmap.org/way/958673591 |
| coordinates (lat, lon) | 50.9067432, -1.2500233 |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 3.12 km |
| that project | Fontley House Farm |
| its capacity | 10 MW |
| its inferred window state | **PAST_EXPECTED_START** |
| its REPD reference | `6392` |
