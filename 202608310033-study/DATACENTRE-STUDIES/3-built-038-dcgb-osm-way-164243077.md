# DCGB-OSM-WAY-164243077

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 38 / 100  |  OSM element `DCGB-OSM-WAY-164243077`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-164243077` |
| OSM element | https://www.openstreetmap.org/way/164243077 |
| coordinates (lat, lon) | 51.5242683, -0.079315 |
...
The nearest named point in the pinned V8 `datacentres` layer is 0.29 km away, recorded as "Redcentric London City".
...
| measure | value |
|---|---|
| nearest transmission circuit | 0.06 km at 132 kV |
| nearest substation | 0.21 km |
| that substation, voltage | 66000 / 11000 |
| that substation, name | Hearn Street Substation |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 4.41 km |
