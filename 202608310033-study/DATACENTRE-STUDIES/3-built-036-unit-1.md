...
**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 36 / 100  |  OSM element `DCGB-OSM-WAY-460244923`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-460244923` |
| OSM element | https://www.openstreetmap.org/way/460244923 |
| coordinates (lat, lon) | 51.2477532, -0.1596895 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 6.45 km at 132 kV |
| nearest substation | 0.08 km |
| that substation, voltage | 33000 |
| that substation, name | Redhill Primary |

Within 6.45 km of a 132 kV circuit - a workable connection distance for a load of this kind.

## 4. Generation adjacency - the pairing that matters

| measure | value |
|---|---|
| nearest live solar or BESS project | 3.18 km |
| that project | East Surrey Hospital, Canada Avenue -Solar Panels |
| its capacity | 2.1 MW |
| its inferred window state | **PAST_EXPECTED_START** |
| its REPD reference | `19745` |
