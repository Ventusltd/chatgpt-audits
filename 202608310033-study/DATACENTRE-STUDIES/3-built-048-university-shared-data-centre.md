...
**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 48 / 100  |  OSM element `DCGB-OSM-NODE-12512246491`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-NODE-12512246491` |
| OSM element | https://www.openstreetmap.org/node/12512246491 |
| coordinates (lat, lon) | 51.759604, -1.2521857 |
...
element: **University Shared Data Centre**.
...
| measure | value |
|---|---|
| nearest transmission circuit | 1.99 km at 132 kV |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 3.68 km |
| that project | Botley - Solar Photovoltaic Array |
| its capacity | 49.99 MW |
| its inferred window state | **PRE_CONSENT** |
| its REPD reference | `18174` |
