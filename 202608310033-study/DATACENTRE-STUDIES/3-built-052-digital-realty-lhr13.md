# Digital Realty LHR13

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 52 / 100  |  OSM element `DCGB-OSM-WAY-27756169`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-27756169` |
| OSM element | https://www.openstreetmap.org/way/27756169 |
| coordinates (lat, lon) | 51.3683288, -0.2911225 |
...
| that substation, name | Tolworth DC Traction Substation |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 6.90 km |
| that project | Barnett Wood Lane - Battery Storage |
| its capacity | 98 MW |
| its inferred window state | **FUNDING_WINDOW_INFERRED** |
| its REPD reference | `12919` |

A live generation project inside the inferred commercial window sits 6.90 km away. Too far for a private wire
