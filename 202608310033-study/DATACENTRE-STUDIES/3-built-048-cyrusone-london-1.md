...
**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 48 / 100  |  OSM element `DCGB-OSM-WAY-665572148`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-665572148` |
| OSM element | https://www.openstreetmap.org/way/665572148 |
| coordinates (lat, lon) | 51.523045, -0.6239391 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 0.17 km at 132 kV |
