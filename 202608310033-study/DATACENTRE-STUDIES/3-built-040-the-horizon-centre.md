...
**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 40 / 100  |  OSM element `DCGB-OSM-WAY-503988314`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-503988314` |
| OSM element | https://www.openstreetmap.org/way/503988314 |
| coordinates (lat, lon) | 52.516024, -0.645899 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 2.42 km at 132 kV |
| nearest substation | 0.29 km |
| that substation, voltage | 33000 |
| that substation, name | Rockingham Data Centre Substation |

Within 2.42 km of a 132 kV circuit - a workable connection distance for a load of this kind.

## 4. Generation adjacency - the pairing that matters

| measure | value |
|---|---|
| nearest live solar or BESS project | 0.39 km |
| that project | Horizon Centre, Gretton Road - Solar Array |
| its capacity | 1.4 MW |
| its inferred window state | **PRE_CONSENT** |
| its REPD reference | `19841` |
