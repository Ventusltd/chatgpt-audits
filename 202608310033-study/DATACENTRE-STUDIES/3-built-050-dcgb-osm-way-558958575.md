# DCGB-OSM-WAY-558958575

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 50 / 100  |  OSM element `DCGB-OSM-WAY-558958575`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-558958575` |
| OSM element | https://www.openstreetmap.org/way/558958575 |
| coordinates (lat, lon) | 51.6020084, -1.7301983 |
...
The nearest named point in the pinned V8 `datacentres` layer is 8.07 km away, recorded as "Nationwide Swindon Technology Centre".
...
| measure | value |
|---|---|
| nearest transmission circuit | 1.79 km at 132 kV |
| nearest substation | 1.82 km |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 0.38 km |
| that project | Queenslaine Farm, Highworth Road - Battery Energy Storage System |
| its capacity | 66 MW |
| its inferred window state | **PROCURING_INFERRED** |
| its REPD reference | `18424` |

**This is the high-value case.** A live generation project inside the inferred commercial window sits within
0.38 km of this load. Private-wire, co-location and behind-the-meter conversations are live *now*, and the
