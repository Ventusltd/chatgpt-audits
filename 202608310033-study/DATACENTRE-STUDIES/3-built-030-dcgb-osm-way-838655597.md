# DCGB-OSM-WAY-838655597

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 30 / 100  |  OSM element `DCGB-OSM-WAY-838655597`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-838655597` |
| OSM element | https://www.openstreetmap.org/way/838655597 |
| coordinates (lat, lon) | 51.2817675, -0.7972979 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 2.55 km at 132 kV |
| nearest substation | 0.10 km |
| that substation, voltage | 33000 |
| that substation, name | _unnamed in source_ |

Within 2.55 km of a 132 kV circuit - a workable connection distance for a load of this kind.

## 4. Generation adjacency - the pairing that matters

| measure | value |
|---|---|
| nearest live solar or BESS project | 2.71 km |
