# Tata Communications Highbridge Datacentre

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 36 / 100  |  OSM element `DCGB-OSM-WAY-134915217`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-134915217` |
| OSM element | https://www.openstreetmap.org/way/134915217 |
| coordinates (lat, lon) | 51.2275256, -2.9631583 |
...
element: **Tata Communications Highbridge Datacentre**.
...
| measure | value |
|---|---|
| nearest transmission circuit | 3.77 km at 400 kV |
| nearest substation | 1.37 km |
| that substation, voltage | 33000 |
| that substation, name | Watchfield Lawn 33kV Solar |

Within 3.77 km of a 400 kV circuit - a workable connection distance for a load of this kind.

## 4. Generation adjacency - the pairing that matters

| measure | value |
|---|---|
| nearest live solar or BESS project | 9.66 km |
| that project | Saltlands Avenue - Solar Parks |
| its capacity | 8.887 MW |
| its inferred window state | **PRE_CONSENT** |
| its REPD reference | `10136` |
