# DCGB-OSM-WAY-665572144

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 38 / 100  |  OSM element `DCGB-OSM-WAY-665572144`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-665572144` |
| OSM element | https://www.openstreetmap.org/way/665572144 |
| coordinates (lat, lon) | 51.5222507, -0.6245867 |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 3.67 km |
