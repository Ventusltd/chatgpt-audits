# 4D Data Centers - Gatwick

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 44 / 100  |  OSM element `DCGB-OSM-WAY-23674117`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-23674117` |
| OSM element | https://www.openstreetmap.org/way/23674117 |
| coordinates (lat, lon) | 51.1324806, -0.1758407 |
...
element: **4D Data Centers - Gatwick**.
...
| that substation, name | Crawley Industrial East 33/11kV |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 9.69 km |
