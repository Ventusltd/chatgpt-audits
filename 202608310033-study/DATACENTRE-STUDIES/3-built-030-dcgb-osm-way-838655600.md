# DCGB-OSM-WAY-838655600

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 30 / 100  |  OSM element `DCGB-OSM-WAY-838655600`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-838655600` |
| OSM element | https://www.openstreetmap.org/way/838655600 |
| coordinates (lat, lon) | 51.2817263, -0.7954006 |
...
Within 2.57 km of a 132 kV circuit - a workable connection distance for a load of this kind.

## 4. Generation adjacency - the pairing that matters

| measure | value |
|---|---|
| nearest live solar or BESS project | 2.58 km |
