# DCGB-OSM-WAY-42031440

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 38 / 100  |  OSM element `DCGB-OSM-WAY-42031440`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-42031440` |
| OSM element | https://www.openstreetmap.org/way/42031440 |
| coordinates (lat, lon) | 51.5189837, -0.1803439 |
...
The nearest named point in the pinned V8 `datacentres` layer is 5.37 km away, recorded as "Unknown Data Centre".
...
| measure | value |
|---|---|
| nearest transmission circuit | 0.31 km at 400 kV |
| nearest substation | 0.82 km |
| that substation, voltage | 132000 / 11000 |
| that substation, name | Aberdeen Place B Substation |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 3.11 km |
