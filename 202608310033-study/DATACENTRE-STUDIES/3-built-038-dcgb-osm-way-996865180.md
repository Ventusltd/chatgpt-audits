# DCGB-OSM-WAY-996865180

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 38 / 100  |  OSM element `DCGB-OSM-WAY-996865180`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-996865180` |
| OSM element | https://www.openstreetmap.org/way/996865180 |
| coordinates (lat, lon) | 51.4177591, -2.2197302 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 0.98 km at 275 kV |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 2.65 km |
