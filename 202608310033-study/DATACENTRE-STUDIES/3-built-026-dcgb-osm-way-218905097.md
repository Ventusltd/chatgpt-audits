# DCGB-OSM-WAY-218905097

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 26 / 100  |  OSM element `DCGB-OSM-WAY-218905097`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-218905097` |
| OSM element | https://www.openstreetmap.org/way/218905097 |
| coordinates (lat, lon) | 51.5425077, -0.3366447 |
...
The nearest named point in the pinned V8 `datacentres` layer is 1.91 km away, recorded as "Kao Data KLON-05".
...
| measure | value |
|---|---|
| nearest transmission circuit | 5.13 km at 132 kV |
| nearest substation | 0.77 km |
| that substation, voltage | 33000 / 11000 |
| that substation, name | _unnamed in source_ |

Within 5.13 km of a 132 kV circuit - a workable connection distance for a load of this kind.

## 4. Generation adjacency - the pairing that matters

| measure | value |
|---|---|
| nearest live solar or BESS project | 4.54 km |
