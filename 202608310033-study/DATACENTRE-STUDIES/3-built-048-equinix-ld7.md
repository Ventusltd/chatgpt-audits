...
**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 48 / 100  |  OSM element `DCGB-OSM-WAY-735444062`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-735444062` |
| OSM element | https://www.openstreetmap.org/way/735444062 |
| coordinates (lat, lon) | 51.5255429, -0.634531 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 0.82 km at 132 kV |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 4.25 km |
