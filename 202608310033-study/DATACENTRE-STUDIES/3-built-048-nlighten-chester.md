...
**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 48 / 100  |  OSM element `DCGB-OSM-WAY-256764286`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-256764286` |
| OSM element | https://www.openstreetmap.org/way/256764286 |
| coordinates (lat, lon) | 53.2452627, -2.9295354 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 0.21 km at 132 kV |
| nearest substation | 0.06 km |
| that substation, voltage | 33000 / 11000 |
| that substation, name | Unilever Dunkirk |
...
| that project | Capenhurst Lane, Capenhurst - Battery Storage |
| its capacity | 100 MW |
| its inferred window state | **PAST_EXPECTED_START** |
| its REPD reference | `12503` |
