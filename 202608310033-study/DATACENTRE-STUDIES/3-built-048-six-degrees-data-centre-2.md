...
**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 48 / 100  |  OSM element `DCGB-OSM-WAY-375842478`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-375842478` |
| OSM element | https://www.openstreetmap.org/way/375842478 |
| coordinates (lat, lon) | 51.4937101, 0.0310638 |
...
element: **Six Degrees Data Centre**.
...
| measure | value |
|---|---|
| nearest transmission circuit | 1.73 km at 400 kV |
| nearest substation | 0.78 km |
| that substation, voltage | 33000 / 750 |
| that substation, name | Charlton DC Traction Substation |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 3.54 km |
