# DCGB-OSM-WAY-194258564

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 38 / 100  |  OSM element `DCGB-OSM-WAY-194258564`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-194258564` |
| OSM element | https://www.openstreetmap.org/way/194258564 |
| coordinates (lat, lon) | 51.4954355, -0.0190627 |
...
The nearest named point in the pinned V8 `datacentres` layer is 0.16 km away, recorded as "Digital Realty LHR19".
...
| measure | value |
|---|---|
| nearest transmission circuit | 1.33 km at 132 kV |
| nearest substation | 0.59 km |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 0.78 km |
