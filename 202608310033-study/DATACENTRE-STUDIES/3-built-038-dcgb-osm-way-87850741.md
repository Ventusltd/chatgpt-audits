# DCGB-OSM-WAY-87850741

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 38 / 100  |  OSM element `DCGB-OSM-WAY-87850741`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-87850741` |
| OSM element | https://www.openstreetmap.org/way/87850741 |
| coordinates (lat, lon) | 52.5562815, -0.2640718 |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 0.57 km |
