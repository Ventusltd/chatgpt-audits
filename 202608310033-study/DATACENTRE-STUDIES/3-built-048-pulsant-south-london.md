# Pulsant South London

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 48 / 100  |  OSM element `DCGB-OSM-WAY-180779572`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-180779572` |
| OSM element | https://www.openstreetmap.org/way/180779572 |
| coordinates (lat, lon) | 51.3535862, -0.1195452 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 1.16 km at 400 kV |
| nearest substation | 0.62 km |
| that substation, voltage | 33000 / 11000 |
| that substation, name | West Croydon Substation |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 4.78 km |
| that project | Selhurst Traincare Depot, Selhurst Road - Solar Panels |
| its capacity | 1 MW |
| its inferred window state | **PAST_EXPECTED_START** |
| its REPD reference | `19709` |
