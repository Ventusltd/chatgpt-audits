...
**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 40 / 100  |  OSM element `DCGB-OSM-NODE-13179027944`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-NODE-13179027944` |
| OSM element | https://www.openstreetmap.org/node/13179027944 |
| coordinates (lat, lon) | 54.6047075, -5.9202218 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 4.45 km at 275 kV |
| nearest substation | 0.44 km |
| that substation, voltage | 33000 |
| that substation, name | Talbot Street 33kV Substation |

Within 4.45 km of a 275 kV circuit - a workable connection distance for a load of this kind.

## 4. Generation adjacency - the pairing that matters

| measure | value |
|---|---|
| nearest live solar or BESS project | 1.13 km |
