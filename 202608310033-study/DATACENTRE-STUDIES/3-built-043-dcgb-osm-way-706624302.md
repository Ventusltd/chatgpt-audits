# DCGB-OSM-WAY-706624302

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 43 / 100  |  OSM element `DCGB-OSM-WAY-706624302`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-706624302` |
| OSM element | https://www.openstreetmap.org/way/706624302 |
| coordinates (lat, lon) | 51.5312555, -0.257339 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 0.27 km at 400 kV |
| nearest substation | 0.30 km |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 1.16 km |
