...
**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 52 / 100  |  OSM element `DCGB-OSM-NODE-9458930462`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-NODE-9458930462` |
| OSM element | https://www.openstreetmap.org/node/9458930462 |
| coordinates (lat, lon) | 51.5701871, 0.6447764 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 4.22 km at 132 kV |
| nearest substation | 0.91 km |
| that substation, voltage | 33000 / 11000 |
| that substation, name | _unnamed in source_ |

Within 4.22 km of a 132 kV circuit - a workable connection distance for a load of this kind.

## 4. Generation adjacency - the pairing that matters

| measure | value |
|---|---|
| nearest live solar or BESS project | 3.21 km |
| that project | Fairlawns Farm, Chelmsford Road - Battery Energy Storage |
| its capacity | 480 MW |
| its inferred window state | **PROCURING_INFERRED** |
| its REPD reference | `16887` |

**This is the high-value case.** A live generation project inside the inferred commercial window sits within
3.21 km of this load. Private-wire, co-location and behind-the-meter conversations are live *now*, and the
