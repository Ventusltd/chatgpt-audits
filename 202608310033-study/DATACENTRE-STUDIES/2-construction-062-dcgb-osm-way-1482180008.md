# DCGB-OSM-WAY-1482180008

**Verdict: WATCH - BUILDING**  |  demand score 62 / 100  |  OSM element `DCGB-OSM-WAY-1482180008`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-1482180008` |
| OSM element | https://www.openstreetmap.org/way/1482180008 |
| coordinates (lat, lon) | 51.5106569, -0.0054992 |
...
The nearest named point in the pinned V8 `datacentres` layer is 0.05 km away, recorded as "Global Switch London North".
...
| measure | value |
|---|---|
| nearest transmission circuit | 0.86 km at 132 kV |
| nearest substation | 0.27 km |
| that substation, voltage | 132000 / 11000 |
| that substation, name | Telehouse Substation |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 1.27 km |
