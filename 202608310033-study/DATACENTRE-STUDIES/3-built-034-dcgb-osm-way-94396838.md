# DCGB-OSM-WAY-94396838

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 34 / 100  |  OSM element `DCGB-OSM-WAY-94396838`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-94396838` |
| OSM element | https://www.openstreetmap.org/way/94396838 |
| coordinates (lat, lon) | 51.4164884, -0.772372 |
...
The nearest named point in the pinned V8 `datacentres` layer is 0.73 km away, recorded as "Amazon Web Services".
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 5.44 km |
