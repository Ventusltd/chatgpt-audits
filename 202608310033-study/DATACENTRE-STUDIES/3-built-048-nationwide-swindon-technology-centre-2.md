...
**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 48 / 100  |  OSM element `DCGB-OSM-WAY-166184208`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-166184208` |
| OSM element | https://www.openstreetmap.org/way/166184208 |
| coordinates (lat, lon) | 51.5722231, -1.8367418 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 1.09 km at 132 kV |
| nearest substation | 1.52 km |
