# DCGB-OSM-WAY-710050084

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 38 / 100  |  OSM element `DCGB-OSM-WAY-710050084`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-710050084` |
| OSM element | https://www.openstreetmap.org/way/710050084 |
| coordinates (lat, lon) | 52.5409438, -1.3811263 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 1.63 km at 132 kV |
| nearest substation | 1.67 km |
| that substation, voltage | 132000 / 33000 / 11000 |
| that substation, name | Hinckley Substation |
...
| that project | Triumph Motorcycles, Normandy Way - Solar PV Array |
| its capacity | 1.295 MW |
| its inferred window state | **PAST_EXPECTED_START** |
| its REPD reference | `14626` |
