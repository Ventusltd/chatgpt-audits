...
**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 53 / 100  |  OSM element `DCGB-OSM-WAY-490844969`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-490844969` |
| OSM element | https://www.openstreetmap.org/way/490844969 |
| coordinates (lat, lon) | 55.8344313, -3.9525146 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 0.55 km at 275 kV |
| nearest substation | 1.19 km |
| that substation, voltage | 275000 |
| that substation, name | Newarthill Substation |
...
| that project | Brakes, Edinburgh Road - Solar Panels |
| its capacity | 1.35 MW |
| its inferred window state | **PAST_EXPECTED_START** |
| its REPD reference | `13916` |
