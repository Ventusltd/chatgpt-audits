# DCGB-OSM-WAY-364385695

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 26 / 100  |  OSM element `DCGB-OSM-WAY-364385695`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-364385695` |
| OSM element | https://www.openstreetmap.org/way/364385695 |
| coordinates (lat, lon) | 51.1354635, -0.0419907 |
...
| nearest substation | 2.01 km |
| that substation, voltage | 33000 |
| that substation, name | East Grinstead Primary |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 7.68 km |
| that project | Haxted Mead, Lingfield - Solar Farm |
| its capacity | 50 MW |
| its inferred window state | **PRE_CONSENT** |
| its REPD reference | `19401` |
