...
**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 53 / 100  |  OSM element `DCGB-OSM-WAY-1302091424`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-1302091424` |
| OSM element | https://www.openstreetmap.org/way/1302091424 |
| coordinates (lat, lon) | 52.5473033, -2.0305574 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 0.04 km at 275 kV |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 0.44 km |
