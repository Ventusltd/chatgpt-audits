...
**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 48 / 100  |  OSM element `DCGB-OSM-WAY-90550466`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-90550466` |
| OSM element | https://www.openstreetmap.org/way/90550466 |
| coordinates (lat, lon) | 51.1989076, -0.1642598 |
...
element: **Restore Records Management**.
...
| measure | value |
|---|---|
| nearest transmission circuit | 1.23 km at 132 kV |
| nearest substation | 0.21 km |
| that substation, voltage | 33000 / 750 |
| that substation, name | Salfords DC Traction Substation |
