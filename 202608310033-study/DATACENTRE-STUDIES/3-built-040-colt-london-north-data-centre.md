# Colt London North Data Centre

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 40 / 100  |  OSM element `DCGB-OSM-WAY-98134606`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-98134606` |
| OSM element | https://www.openstreetmap.org/way/98134606 |
| coordinates (lat, lon) | 51.799948, -0.1835561 |
...
element: **Colt London North Data Centre**.
...
| measure | value |
|---|---|
| nearest transmission circuit | 2.24 km at 132 kV |
| nearest substation | 0.13 km |
| that substation, voltage | 132000 |
| that substation, name | Black Fan Substation |

Within 2.24 km of a 132 kV circuit - a workable connection distance for a load of this kind.

## 4. Generation adjacency - the pairing that matters

| measure | value |
|---|---|
| nearest live solar or BESS project | 0.89 km |
| that project | Welwyn Power - Energy Storage Facility |
| its capacity | 5 MW |
| its inferred window state | **PAST_EXPECTED_START** |
| its REPD reference | `11536` |
