...
**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 48 / 100  |  OSM element `DCGB-OSM-WAY-38242832`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-38242832` |
| OSM element | https://www.openstreetmap.org/way/38242832 |
| coordinates (lat, lon) | 51.568191, -0.2308517 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 1.41 km at 400 kV |
| nearest substation | 1.42 km |
