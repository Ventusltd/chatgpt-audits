...
**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 40 / 100  |  OSM element `DCGB-OSM-WAY-305726393`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-305726393` |
| OSM element | https://www.openstreetmap.org/way/305726393 |
| coordinates (lat, lon) | 52.2088956, 0.079334 |
...
element: **West Cambridge Data Centre**.
...
| measure | value |
|---|---|
| nearest transmission circuit | 3.38 km at 132 kV |
| nearest substation | 0.73 km |
| that substation, voltage | 33000 / 11000 |
| that substation, name | Madingley Road Primary Substation |

Within 3.38 km of a 132 kV circuit - a workable connection distance for a load of this kind.

## 4. Generation adjacency - the pairing that matters

| measure | value |
|---|---|
| nearest live solar or BESS project | 4.57 km |
| that project | Barton Road, Barton - Solar Farm |
| its capacity | 5 MW |
| its inferred window state | **PAST_EXPECTED_START** |
| its REPD reference | `10578` |
