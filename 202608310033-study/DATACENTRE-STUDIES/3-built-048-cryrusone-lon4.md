...
**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 48 / 100  |  OSM element `DCGB-OSM-WAY-787209296`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-787209296` |
| OSM element | https://www.openstreetmap.org/way/787209296 |
| coordinates (lat, lon) | 51.5165511, -0.6289481 |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 4.17 km |
