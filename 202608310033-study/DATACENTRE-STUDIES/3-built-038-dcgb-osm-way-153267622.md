# DCGB-OSM-WAY-153267622

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 38 / 100  |  OSM element `DCGB-OSM-WAY-153267622`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-153267622` |
| OSM element | https://www.openstreetmap.org/way/153267622 |
| coordinates (lat, lon) | 55.8762813, -3.4812859 |
...
The nearest named point in the pinned V8 `datacentres` layer is 7.40 km away, recorded as "Edinburgh SC-3".
...
| measure | value |
|---|---|
| nearest transmission circuit | 1.01 km at 132 kV |
| nearest substation | 0.99 km |
| that substation, voltage | 132000 / 33000 |
| that substation, name | Livingston East Substation |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 1.83 km |
| that project | Drumshoreland Road Battery Storage Facility |
| its capacity | 49.9 MW |
| its inferred window state | **PAST_EXPECTED_START** |
| its REPD reference | `8920` |
