...
**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 53 / 100  |  OSM element `DCGB-OSM-WAY-706624303`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-706624303` |
| OSM element | https://www.openstreetmap.org/way/706624303 |
| coordinates (lat, lon) | 51.5319396, -0.2576058 |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 1.10 km |
