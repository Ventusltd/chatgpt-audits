# DCGB-OSM-WAY-1540942790

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 30 / 100  |  OSM element `DCGB-OSM-WAY-1540942790`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-1540942790` |
| OSM element | https://www.openstreetmap.org/way/1540942790 |
| coordinates (lat, lon) | 50.8664189, -0.9756791 |
...
The nearest named point in the pinned V8 `datacentres` layer is 13.54 km away, recorded as "ServerHouse".
...
| measure | value |
|---|---|
| nearest transmission circuit | 2.38 km at 132 kV |
| nearest substation | 2.48 km |
| that substation, voltage | 33000 / 11000 |
| that substation, name | Brockhampton Substation |

Within 2.38 km of a 132 kV circuit - a workable connection distance for a load of this kind.

## 4. Generation adjacency - the pairing that matters

| measure | value |
|---|---|
| nearest live solar or BESS project | 1.50 km |
| that project | Bedhampton Pumping Station, Meyrick Road - Battery Energy Storage |
| its capacity | 150 MW |
| its inferred window state | **PRE_CONSENT** |
| its REPD reference | `18986` |
