# DCGB-OSM-WAY-220442829

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 30 / 100  |  OSM element `DCGB-OSM-WAY-220442829`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-220442829` |
| OSM element | https://www.openstreetmap.org/way/220442829 |
| coordinates (lat, lon) | 53.0064897, -1.2145155 |
...
The nearest named point in the pinned V8 `datacentres` layer is 14.86 km away, recorded as "Experian".
...
| measure | value |
|---|---|
| nearest transmission circuit | 4.10 km at 132 kV |
| nearest substation | 1.15 km |
| that substation, voltage | 33000 / 11000 |
| that substation, name | Bulwell Substation |

Within 4.10 km of a 132 kV circuit - a workable connection distance for a load of this kind.

## 4. Generation adjacency - the pairing that matters

| measure | value |
|---|---|
| nearest live solar or BESS project | 1.53 km |
| that project | ITP Aero, Harrier Park - Solar Panels |
| its capacity | 1.9 MW |
| its inferred window state | **PAST_EXPECTED_START** |
| its REPD reference | `17597` |
