...
**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 48 / 100  |  OSM element `DCGB-OSM-WAY-28074414`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-28074414` |
| OSM element | https://www.openstreetmap.org/way/28074414 |
| coordinates (lat, lon) | 50.8683934, -1.2471827 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 0.55 km at 400 kV |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 0.32 km |
