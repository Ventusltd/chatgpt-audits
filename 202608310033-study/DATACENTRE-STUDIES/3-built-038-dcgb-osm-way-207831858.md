# DCGB-OSM-WAY-207831858

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 38 / 100  |  OSM element `DCGB-OSM-WAY-207831858`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-207831858` |
| OSM element | https://www.openstreetmap.org/way/207831858 |
| coordinates (lat, lon) | 53.7830763, -1.5734609 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 0.77 km at 132 kV |
| nearest substation | 1.04 km |
