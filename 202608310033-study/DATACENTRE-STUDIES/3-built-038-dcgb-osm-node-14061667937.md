# DCGB-OSM-NODE-14061667937

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 38 / 100  |  OSM element `DCGB-OSM-NODE-14061667937`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-NODE-14061667937` |
| OSM element | https://www.openstreetmap.org/node/14061667937 |
| coordinates (lat, lon) | 51.4614715, -0.9259691 |
...
The nearest named point in the pinned V8 `datacentres` layer is 1.18 km away, recorded as "Pulsant Reading East".
...
| measure | value |
|---|---|
| nearest transmission circuit | 0.31 km at 132 kV |
| nearest substation | 0.31 km |
| that substation, voltage | 132000 |
| that substation, name | Reading Main Substation |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 1.18 km |
