...
**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 36 / 100  |  OSM element `DCGB-OSM-WAY-460244927`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-460244927` |
| OSM element | https://www.openstreetmap.org/way/460244927 |
| coordinates (lat, lon) | 51.2479408, -0.1572905 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 6.53 km at 132 kV |
| nearest substation | 0.18 km |
| that substation, voltage | 33000 |
| that substation, name | Redhill Primary |

Within 6.53 km of a 132 kV circuit - a workable connection distance for a load of this kind.
