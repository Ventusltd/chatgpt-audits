...
**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 48 / 100  |  OSM element `DCGB-OSM-WAY-1481564428`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-1481564428` |
| OSM element | https://www.openstreetmap.org/way/1481564428 |
| coordinates (lat, lon) | 51.4981784, -0.0148988 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 1.41 km at 132 kV |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 0.52 km |
