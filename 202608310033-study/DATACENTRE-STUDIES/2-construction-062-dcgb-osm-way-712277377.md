# DCGB-OSM-WAY-712277377

**Verdict: WATCH - BUILDING**  |  demand score 62 / 100  |  OSM element `DCGB-OSM-WAY-712277377`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-712277377` |
| OSM element | https://www.openstreetmap.org/way/712277377 |
| coordinates (lat, lon) | 51.525353, -0.6329984 |
...
The nearest named point in the pinned V8 `datacentres` layer is 0.11 km away, recorded as "Equinix LD7".
...
| measure | value |
|---|---|
| nearest transmission circuit | 0.72 km at 132 kV |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 4.15 km |
