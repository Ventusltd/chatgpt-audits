...
**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 60 / 100  |  OSM element `DCGB-OSM-WAY-53045250`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-53045250` |
| OSM element | https://www.openstreetmap.org/way/53045250 |
| coordinates (lat, lon) | 51.4811413, 0.2700957 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 0.82 km at 400 kV |
| nearest substation | 0.10 km |
| that substation, voltage | 33000 / 11000 |
| that substation, name | Barclay Way Substation |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 0.95 km |
| that project | Tesco, Cygnet View - Solar PV Arrays |
| its capacity | 1.05 MW |
| its inferred window state | **PROCURING_INFERRED** |
| its REPD reference | `20282` |

**This is the high-value case.** A live generation project inside the inferred commercial window sits within
0.95 km of this load. Private-wire, co-location and behind-the-meter conversations are live *now*, and the
