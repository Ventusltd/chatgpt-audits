# DCGB-OSM-WAY-447245010

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 38 / 100  |  OSM element `DCGB-OSM-WAY-447245010`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-447245010` |
| OSM element | https://www.openstreetmap.org/way/447245010 |
| coordinates (lat, lon) | 51.5163646, -0.614636 |
...
The nearest named point in the pinned V8 `datacentres` layer is 0.12 km away, recorded as "NTT Slough".
...
| measure | value |
|---|---|
| nearest transmission circuit | 0.22 km at 132 kV |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 3.31 km |
