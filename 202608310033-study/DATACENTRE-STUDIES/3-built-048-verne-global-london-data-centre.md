# Verne Global London Data Centre

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 48 / 100  |  OSM element `DCGB-OSM-WAY-33503496`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-33503496` |
| OSM element | https://www.openstreetmap.org/way/33503496 |
| coordinates (lat, lon) | 51.5235766, -0.1008144 |
...
element: **Verne Global London Data Centre**.
...
| measure | value |
|---|---|
| nearest transmission circuit | 0.15 km at 132 kV |
| nearest substation | 0.62 km |
| that substation, voltage | 132000 / 11000 |
| that substation, name | Beech Street Substation |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 3.04 km |
