...
**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 53 / 100  |  OSM element `DCGB-OSM-NODE-7778067710`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-NODE-7778067710` |
| OSM element | https://www.openstreetmap.org/node/7778067710 |
| coordinates (lat, lon) | 51.5550188, -3.0382722 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 0.73 km at 400 kV |
| nearest substation | 0.94 km |
