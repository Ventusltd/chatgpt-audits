# DCGB-OSM-WAY-70521778

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 38 / 100  |  OSM element `DCGB-OSM-WAY-70521778`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-70521778` |
| OSM element | https://www.openstreetmap.org/way/70521778 |
| coordinates (lat, lon) | 51.4256273, -0.9716398 |
...
The nearest named point in the pinned V8 `datacentres` layer is 0.60 km away, recorded as "Redcentric Reading".
...
| measure | value |
|---|---|
| nearest transmission circuit | 1.57 km at 132 kV |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 4.07 km |
