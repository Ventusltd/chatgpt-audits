# DCGB-OSM-NODE-14056400574

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 30 / 100  |  OSM element `DCGB-OSM-NODE-14056400574`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-NODE-14056400574` |
| OSM element | https://www.openstreetmap.org/node/14056400574 |
| coordinates (lat, lon) | 53.4789028, -2.2386018 |
...
The nearest named point in the pinned V8 `datacentres` layer is 1.64 km away, recorded as "Equinix MA1".
...
| measure | value |
|---|---|
| nearest transmission circuit | 3.68 km at 132 kV |
| nearest substation | 0.33 km |
| that substation, voltage | 132000 |
| that substation, name | BLOOM ST GRID |

Within 3.68 km of a 132 kV circuit - a workable connection distance for a load of this kind.

## 4. Generation adjacency - the pairing that matters

| measure | value |
|---|---|
| nearest live solar or BESS project | 2.99 km |
| that project | City Football Academy - Solar Panels |
| its capacity | 1.12 MW |
| its inferred window state | **PAST_EXPECTED_START** |
| its REPD reference | `17465` |
