...
**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 53 / 100  |  OSM element `DCGB-OSM-NODE-12300408592`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-NODE-12300408592` |
| OSM element | https://www.openstreetmap.org/node/12300408592 |
| coordinates (lat, lon) | 55.8613892, -4.2651336 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 0.23 km at 275 kV |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 1.78 km |
