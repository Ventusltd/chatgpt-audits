# DCGB-OSM-WAY-838655599

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 30 / 100  |  OSM element `DCGB-OSM-WAY-838655599`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-838655599` |
| OSM element | https://www.openstreetmap.org/way/838655599 |
| coordinates (lat, lon) | 51.2821, -0.7957685 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 2.53 km at 132 kV |
| nearest substation | 0.17 km |
| that substation, voltage | 33000 |
| that substation, name | _unnamed in source_ |

Within 2.53 km of a 132 kV circuit - a workable connection distance for a load of this kind.

## 4. Generation adjacency - the pairing that matters

| measure | value |
|---|---|
| nearest live solar or BESS project | 2.61 km |
