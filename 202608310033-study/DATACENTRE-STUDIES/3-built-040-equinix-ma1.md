...
**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 40 / 100  |  OSM element `DCGB-OSM-NODE-12303136063`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-NODE-12303136063` |
| OSM element | https://www.openstreetmap.org/node/12303136063 |
| coordinates (lat, lon) | 53.4642039, -2.2363205 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 4.36 km at 132 kV |
| nearest substation | 1.33 km |
| that substation, voltage | 132000 |
| that substation, name | BLOOM ST GRID |

Within 4.36 km of a 132 kV circuit - a workable connection distance for a load of this kind.

## 4. Generation adjacency - the pairing that matters

| measure | value |
|---|---|
| nearest live solar or BESS project | 3.41 km |
