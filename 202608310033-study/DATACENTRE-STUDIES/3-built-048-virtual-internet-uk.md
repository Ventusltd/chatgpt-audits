...
**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 48 / 100  |  OSM element `DCGB-OSM-WAY-1001246921`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-1001246921` |
| OSM element | https://www.openstreetmap.org/way/1001246921 |
| coordinates (lat, lon) | 51.5166504, 0.0233541 |
...
| nearest substation | 1.30 km |
| that substation, voltage | 132000 / 22000 |
| that substation, name | Limmo Peninsula Substation |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 3.28 km |
