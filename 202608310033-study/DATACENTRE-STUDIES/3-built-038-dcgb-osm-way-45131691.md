# DCGB-OSM-WAY-45131691

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 38 / 100  |  OSM element `DCGB-OSM-WAY-45131691`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-45131691` |
| OSM element | https://www.openstreetmap.org/way/45131691 |
| coordinates (lat, lon) | 51.5314309, -0.2558878 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 0.21 km at 400 kV |
| nearest substation | 0.25 km |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 1.24 km |
