# Digital Realty LHR19

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 48 / 100  |  OSM element `DCGB-OSM-WAY-191842525`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-191842525` |
| OSM element | https://www.openstreetmap.org/way/191842525 |
| coordinates (lat, lon) | 51.4968425, -0.0188136 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 1.49 km at 132 kV |
| nearest substation | 0.51 km |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 0.62 km |
