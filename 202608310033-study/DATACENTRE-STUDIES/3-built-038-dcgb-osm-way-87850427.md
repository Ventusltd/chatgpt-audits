# DCGB-OSM-WAY-87850427

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 38 / 100  |  OSM element `DCGB-OSM-WAY-87850427`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-87850427` |
| OSM element | https://www.openstreetmap.org/way/87850427 |
| coordinates (lat, lon) | 52.5562036, -0.2627586 |
...
| that substation, name | Peterborough South Substation |
...
| that project | J S Davidson Limited, Shrewsbury Avenue - Solar PV panels |
| its capacity | 1.44 MW |
| its inferred window state | **PAST_EXPECTED_START** |
| its REPD reference | `16890` |
