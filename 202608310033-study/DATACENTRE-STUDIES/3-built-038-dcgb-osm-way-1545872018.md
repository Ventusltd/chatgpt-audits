# DCGB-OSM-WAY-1545872018

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 38 / 100  |  OSM element `DCGB-OSM-WAY-1545872018`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-1545872018` |
| OSM element | https://www.openstreetmap.org/way/1545872018 |
| coordinates (lat, lon) | 51.5377102, -0.1321309 |
...
The nearest named point in the pinned V8 `datacentres` layer is 2.42 km away, recorded as "Stellanor London North".
...
| measure | value |
|---|---|
| nearest transmission circuit | 0.06 km at 400 kV |
| nearest substation | 0.38 km |
| that substation, voltage | 132000 / 66000 / 11000 |
| that substation, name | St Pancras Substation |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 3.20 km |
| that project | Pegasus House, Sackville Street - Roof Mounted Solar Panels |
| its capacity | 2.3 MW |
| its inferred window state | **PAST_EXPECTED_START** |
| its REPD reference | `9924` |
