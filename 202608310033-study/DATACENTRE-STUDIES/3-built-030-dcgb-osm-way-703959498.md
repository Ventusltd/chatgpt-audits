# DCGB-OSM-WAY-703959498

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 30 / 100  |  OSM element `DCGB-OSM-WAY-703959498`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-703959498` |
| OSM element | https://www.openstreetmap.org/way/703959498 |
| coordinates (lat, lon) | 53.4683964, -2.1768304 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 2.32 km at 132 kV |
| nearest substation | 2.30 km |
| that substation, voltage | 132000 |
| that substation, name | Droylsden |

Within 2.32 km of a 132 kV circuit - a workable connection distance for a load of this kind.
