...
**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 53 / 100  |  OSM element `DCGB-OSM-NODE-11640787539`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-NODE-11640787539` |
| OSM element | https://www.openstreetmap.org/node/11640787539 |
| coordinates (lat, lon) | 51.5206017, -0.0009807 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 0.15 km at 400 kV |
| nearest substation | 0.18 km |
| that substation, voltage | 400000 / 132000 |
| that substation, name | West Ham Substation |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 2.35 km |
