# DCGB-OSM-WAY-403124345

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 38 / 100  |  OSM element `DCGB-OSM-WAY-403124345`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-403124345` |
| OSM element | https://www.openstreetmap.org/way/403124345 |
| coordinates (lat, lon) | 53.7084196, -1.883349 |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 2.27 km |
