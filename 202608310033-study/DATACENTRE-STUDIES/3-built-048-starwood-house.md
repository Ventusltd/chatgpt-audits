...
**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 48 / 100  |  OSM element `DCGB-OSM-WAY-178312270`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-178312270` |
| OSM element | https://www.openstreetmap.org/way/178312270 |
| coordinates (lat, lon) | 51.9812122, -0.2068599 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 0.62 km at 400 kV |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 0.42 km |
| that project | Letchworth Garden City - Urban Reserve Energy Storage Facility |
| its capacity | 5 MW |
| its inferred window state | **PAST_EXPECTED_START** |
| its REPD reference | `15927` |
