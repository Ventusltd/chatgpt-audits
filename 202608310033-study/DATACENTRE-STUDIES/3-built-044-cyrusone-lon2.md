...
**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 44 / 100  |  OSM element `DCGB-OSM-WAY-221131413`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-221131413` |
| OSM element | https://www.openstreetmap.org/way/221131413 |
| coordinates (lat, lon) | 51.5027785, -0.4463277 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 2.46 km at 275 kV |
| nearest substation | 0.95 km |
| that substation, voltage | 66000 |
| that substation, name | _unnamed in source_ |

Within 2.46 km of a 275 kV circuit - a workable connection distance for a load of this kind.

## 4. Generation adjacency - the pairing that matters

| measure | value |
|---|---|
| nearest live solar or BESS project | 5.97 km |
...
A live generation project inside the inferred commercial window sits 5.97 km away. Too far for a private wire
