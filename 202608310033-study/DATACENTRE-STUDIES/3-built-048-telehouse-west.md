...
**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 48 / 100  |  OSM element `DCGB-OSM-WAY-34160179`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-34160179` |
| OSM element | https://www.openstreetmap.org/way/34160179 |
| coordinates (lat, lon) | 51.5111949, -0.0023135 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 0.73 km at 132 kV |
