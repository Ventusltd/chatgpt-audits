...
**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 44 / 100  |  OSM element `DCGB-OSM-WAY-732605607`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-732605607` |
| OSM element | https://www.openstreetmap.org/way/732605607 |
| coordinates (lat, lon) | 51.4918316, -3.58071 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 0.50 km at 275 kV |
| nearest substation | 1.59 km |
| that substation, voltage | 33000 / 11000 |
| that substation, name | Bridgend Trading Estate Primary Substation |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 5.11 km |
| that project | Court Colman |
| its capacity | 1 MW |
| its inferred window state | **DISTRESSED** |
| its REPD reference | `6420` |
