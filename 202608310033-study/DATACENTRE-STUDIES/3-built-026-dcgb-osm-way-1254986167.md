# DCGB-OSM-WAY-1254986167

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 26 / 100  |  OSM element `DCGB-OSM-WAY-1254986167`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-1254986167` |
| OSM element | https://www.openstreetmap.org/way/1254986167 |
| coordinates (lat, lon) | 51.8879741, -0.818456 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 3.88 km at 400 kV |
| nearest substation | 6.09 km |
| that substation, voltage | 33000 |
| that substation, name | Buckingham Road Substation |

Within 3.88 km of a 400 kV circuit - a workable connection distance for a load of this kind.

## 4. Generation adjacency - the pairing that matters

| measure | value |
|---|---|
| nearest live solar or BESS project | 5.42 km |
| that project | Longbreach Solar Farm |
| its capacity | 49.9 MW |
| its inferred window state | **PRE_CONSENT** |
| its REPD reference | `14279` |
