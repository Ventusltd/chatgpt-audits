...
**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 48 / 100  |  OSM element `DCGB-OSM-WAY-705065012`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-705065012` |
| OSM element | https://www.openstreetmap.org/way/705065012 |
| coordinates (lat, lon) | 51.525944, -0.6269396 |
...
| measure | value |
|---|---|
| nearest live solar or BESS project | 3.73 km |
