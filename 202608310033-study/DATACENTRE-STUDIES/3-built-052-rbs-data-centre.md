...
**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 52 / 100  |  OSM element `DCGB-OSM-WAY-191603111`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-191603111` |
| OSM element | https://www.openstreetmap.org/way/191603111 |
| coordinates (lat, lon) | 55.9451623, -2.9011761 |
...
| measure | value |
|---|---|
| nearest transmission circuit | 3.65 km at 275 kV |
| nearest substation | 4.06 km |
| that substation, voltage | 33000 |
| that substation, name | _unnamed in source_ |

Within 3.65 km of a 275 kV circuit - a workable connection distance for a load of this kind.

## 4. Generation adjacency - the pairing that matters

| measure | value |
|---|---|
| nearest live solar or BESS project | 4.53 km |
| that project | Cockenzie Battery Storage System - Site A |
| its capacity | 240 MW |
| its inferred window state | **PROCURING_INFERRED** |
| its REPD reference | `14539` |

**This is the high-value case.** A live generation project inside the inferred commercial window sits within
4.53 km of this load. Private-wire, co-location and behind-the-meter conversations are live *now*, and the
