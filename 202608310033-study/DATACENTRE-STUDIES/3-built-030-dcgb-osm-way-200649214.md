# DCGB-OSM-WAY-200649214

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 30 / 100  |  OSM element `DCGB-OSM-WAY-200649214`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-200649214` |
| OSM element | https://www.openstreetmap.org/way/200649214 |
| coordinates (lat, lon) | 53.0791272, -0.7924434 |
...
The nearest named point in the pinned V8 `datacentres` layer is 32.39 km away, recorded as "Experian".
...
| measure | value |
|---|---|
| nearest transmission circuit | 2.97 km at 400 kV |
| nearest substation | 0.42 km |
| that substation, voltage | 33000 / 11000 |
| that substation, name | _unnamed in source_ |

Within 2.97 km of a 400 kV circuit - a workable connection distance for a load of this kind.

## 4. Generation adjacency - the pairing that matters

| measure | value |
|---|---|
| nearest live solar or BESS project | 3.97 km |
