# Redcentric London West

**Verdict: BUILT / UNKNOWN STAGE**  |  demand score 44 / 100  |  OSM element `DCGB-OSM-WAY-254132701`
...
| field | value |
|---|---|
| source record id | `DCGB-OSM-WAY-254132701` |
| OSM element | https://www.openstreetmap.org/way/254132701 |
| coordinates (lat, lon) | 51.468303, -0.3974058 |
...
element: **Redcentric London West**.
...
| measure | value |
|---|---|
| nearest transmission circuit | 3.64 km at 275 kV |
| nearest substation | 1.27 km |
| that substation, voltage | 33000 / 11000 |
| that substation, name | _unnamed in source_ |

Within 3.64 km of a 275 kV circuit - a workable connection distance for a load of this kind.

## 4. Generation adjacency - the pairing that matters

| measure | value |
|---|---|
| nearest live solar or BESS project | 5.15 km |
...
A live generation project inside the inferred commercial window sits 5.15 km away. Too far for a private wire
